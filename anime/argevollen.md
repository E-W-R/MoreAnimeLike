...
<head>
    ...
    <title>More Anime Like Argevollen</title>
...
<body>
    <header>
        <script>const number = "23325";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/12/64453l.jpg" alt="Argevollen">
                <div>
                    <h2 id="title">Argevollen</h2>
                    <p>Action</p>
                    <p>2014</p>
                    <br>
                    <p>In a world torn apart by war between two rival nations, the powerful mecha weapon called Argevollen holds the key to victory. Tokimune, a young mecha pilot, finds himself thrust into the heart of the conflict as he learns to control the Argevollen and navigate the treacherous battlefield. With the fate of the war hanging in the balance, Tokimune must harness his skills and determination to emerge victorious against all odds.</p>
                </div>
            </div>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/2/67515l.jpg" alt="Cross Ange: Rondo of Angel and Dragon">
                </div>
                <div class="details">
                    <a href="cross-ange%3A-rondo-of-angel-and-dragon"><h3>Cross Ange: Rondo of Angel and Dragon</h3></a>
                    <p>Action</p>
                    <p>2014</p>
                    <br>
                    <p>In a world where humanity has advanced technology and can manipulate mana, princess Angelise is exiled to a remote island after being revealed as a Norma, a person unable to use magic. Forced to become a soldier in a war against mysterious dragons, she must navigate betrayal, political machinations, and a shocking truth about the world she lives in to survive and protect her loved ones.</p>
                </div>
            </div>
