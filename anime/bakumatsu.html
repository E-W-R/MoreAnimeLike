...
<head>
    ...
    <title>More Anime Like Bakumatsu</title>
...
<body>
    <header>
        <script>const number = "37584";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/1764/95110l.jpg" alt="Bakumatsu">
                <div>
                    <h2 id="title">Bakumatsu</h2>
                    <p>Action</p>
                    <p>2018</p>
                    <br>
                    <p>In Bakumatsu, the main character is transported back in time to the Bakumatsu period in Japan. He gets caught up in the turmoil and political unrest of the era, where he must navigate between different factions and historical figures. As he tries to find his way back to the present, he becomes embroiled in secret plots and battles, all while forming unlikely alliances and facing powerful adversaries. With his knowledge of future events, he holds the key to changing the course of history.</p>
                </div>
            </div>
