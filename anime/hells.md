...
<head>
    ...
    <title>More Anime Like Hells</title>
...
<body>
    <header>
        <script>const number = "4983";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/1021/135112l.jpg" alt="Hells">
                <div>
                    <h2 id="title">Hells</h2>
                    <p>Comedy</p>
                    <p>2008</p>
                    <br>
                    <p>In Hells, a high school girl named Rinne finds herself in the afterlife, a zany and chaotic dimension known as Hells. With the help of her classmates, including the mysterious blonde boy, she navigates through different realms and faces various challenges in order to return to the living world. As Rinne discovers the truth about her own past, she must overcome her fears and find the strength to fight against powerful adversaries to secure her way back home.</p>
                </div>
            </div>
