...
<head>
    ...
    <title>More Anime Like The Millionaire Detective – Balance: UNLIMITED</title>
...
<body>
    <header>
        <script>const number = "41120";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">The Millionaire Detective – Balance: UNLIMITED</h2>
                    <p>Mystery</p>
                    <p>2020</p>
                    <br>
