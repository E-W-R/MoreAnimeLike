...
<head>
    ...
    <title>More Anime Like Re:ZERO -Starting Life in Another World-</title>
...
<body>
    <header>
        <script>const number = "31240";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Re:ZERO -Starting Life in Another World-</h2>
                    <p>Isekai</p>
                    <p>2016</p>
                    <br>
