...
<head>
    ...
    <title>More Anime Like Ningen Fushin: Adventurers Who Don't Believe in Humanity Will Save the World</title>
...
<body>
    <header>
        <script>const number = "49612";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Ningen Fushin: Adventurers Who Don't Believe in Humanity Will Save the World</h2>
                    <p>Action</p>
                    <p>2023</p>
                    <br>
