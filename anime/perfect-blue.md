...
<head>
    ...
    <title>More Anime Like Perfect Blue</title>
...
<body>
    <header>
        <script>const number = "437";</script>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/1485/141208l.webp" alt="Grave of the Fireflies">
                </div>
                <div class="details">
                    <a href="grave-of-the-fireflies"><h3>Grave of the Fireflies</h3></a>
                    <p>Drama</p>
                    <p>1988</p>
                    <br>
                    <p>Grave of the Fireflies follows two siblings, Seita and Setsuko, trying to survive the horrors of World War II in Japan. After losing their mother during a bombing raid and their father serving in the navy, they are left to fend for themselves. The siblings navigate through the harsh realities of war, struggling with hunger and loss. As they cling to each other for support, their unbreakable bond is tested in the face of despair.</p>
                </div>
            </div>
