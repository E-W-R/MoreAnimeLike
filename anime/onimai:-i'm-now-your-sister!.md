...
<head>
    ...
    <title>More Anime Like Onimai: I'm Now Your Sister!</title>
...
<body>
    <header>
        <script>const number = "51678";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/1058/131632l.jpg" alt="Onimai: I'm Now Your Sister!">
                <div>
                    <h2 id="title">Onimai: I'm Now Your Sister!</h2>
                    <p>Comedy</p>
                    <p>2023</p>
                    <br>
                    <p>When high school student Akira Mizutani's parents adopt two twin sisters, his life takes an unexpected turn. As Akira tries to navigate living with his new siblings, he discovers that the twins are harboring a secret that will change everything. With the bonds of family being tested, Akira must find a way to bring his new family together and overcome any challenges that come their way.</p>
                </div>
            </div>
