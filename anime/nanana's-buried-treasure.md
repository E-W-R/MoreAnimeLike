...
<head>
    ...
    <title>More Anime Like Nanana's Buried Treasure</title>
...
<body>
    <header>
        <script>const number = "21561";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Nanana's Buried Treasure</h2>
                    <p>Mystery</p>
                    <p>2014</p>
                    <br>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/1955/123132l.webp" alt="Zetman">
                </div>
                <div class="details">
                    <a href="zetman"><h3>Zetman</h3></a>
                    <p>Romance</p>
                    <p>2012</p>
                    <br>
                    <p>Zetman follows Jin, a young man with incredible powers who becomes the superhero ZET to protect the city from monstrous creatures. With the help of his friend, Kouga, Jin navigates a world of dangerous experiments, hidden powers, and moral dilemmas. As the two friends fight to uncover their past and protect those they love, they are plunged into a thrilling battle between good and evil that will test their limits.</p>
                </div>
            </div>
