...
<head>
    ...
    <title>More Anime Like Dead Leaves</title>
...
<body>
    <header>
        <script>const number = "974";</script>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/1/1797l.jpg" alt="Animation Runner Kuromi">
                </div>
                <div class="details">
                    <a href="animation-runner-kuromi"><h3>Animation Runner Kuromi</h3></a>
                    <p>Drama</p>
                    <p>2001</p>
                    <br>
                    <p>After landing a job at an animation studio, Kuromi finds herself in charge of a chaotic production. With deadlines looming, she must rally her team of quirky colleagues to complete the project. Through challenges and mishaps, Kuromi's passion for anime is put to the test as she navigates the unpredictable world of animation production. Will she be able to overcome the obstacles and deliver a successful anime on time?</p>
                </div>
            </div>
