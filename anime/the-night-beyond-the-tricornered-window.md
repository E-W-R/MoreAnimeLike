...
<head>
    ...
    <title>More Anime Like The Night Beyond the Tricornered Window</title>
...
<body>
    <header>
        <script>const number = "44387";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">The Night Beyond the Tricornered Window</h2>
                    <p>Mystery</p>
                    <p>2021</p>
                    <br>
