...
<head>
    ...
    <title>More Anime Like 1001 Nights</title>
...
<body>
    <header>
        <script>const number = "3914";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/11/7032l.jpg" alt="1001 Nights">
                <div>
                    <h2 id="title">1001 Nights</h2>
                    <p>Romance</p>
                    <p>1999</p>
                    <br>
                    <p>In 1001 Nights, the beautiful and brave storyteller Scheherazade weaves enchanting tales to captivate the Sultan Shahryar each night, saving herself from execution. As she spins captivating stories filled with adventure, romance, and fantasy, she not only keeps herself alive but also touches the Sultan's heart, slowly changing his cruel ways. Through her storytelling, Scheherazade navigates through a world of magic, danger, and mystery, keeping both the Sultan and the audience spellbound.</p>
                </div>
            </div>
