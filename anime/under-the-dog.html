...
<head>
    ...
    <title>More Anime Like Under the Dog</title>
...
<body>
    <header>
        <script>const number = "27387";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/1793/112240l.webp" alt="Under the Dog">
                <div>
                    <h2 id="title">Under the Dog</h2>
                    <p>Action</p>
                    <p>2016</p>
                    <br>
                    <p>In a futuristic world where a deadly virus threatens humanity, a group of teenage mercenaries is recruited by a clandestine organization to take down a powerful corporation. As they dive into a dangerous mission that will test their skills and loyalty, secrets from the past come to light, revealing hidden agendas and betrayals. With time running out, the team must navigate through intricate webs of deceit and danger to save the world from impending doom.</p>
                </div>
            </div>
