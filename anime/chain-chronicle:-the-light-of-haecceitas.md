...
<head>
    ...
    <title>More Anime Like Chain Chronicle: The Light of Haecceitas</title>
...
<body>
    <header>
        <script>const number = "28833";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Chain Chronicle: The Light of Haecceitas</h2>
                    <p>Action</p>
                    <p>2017</p>
                    <br>
