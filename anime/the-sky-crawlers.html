...
<head>
    ...
    <title>More Anime Like The Sky Crawlers</title>
...
<body>
    <header>
        <script>const number = "3089";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/8/8212l.jpg" alt="The Sky Crawlers">
                <div>
                    <h2 id="title">The Sky Crawlers</h2>
                    <p>Drama</p>
                    <p>2008</p>
                    <br>
                    <p>In a world where perpetual war is waged by genetically engineered pilots known as Kildren, a young pilot named Yuichi is assigned to a remote base. As he becomes embroiled in the challenges of aerial combat and the mysterious past of his fellow pilots, he begins to question the true nature of the endless war and the reasons behind their existence as Sky Crawlers.</p>
                </div>
            </div>
