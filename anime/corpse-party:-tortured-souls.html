...
<head>
    ...
    <title>More Anime Like Corpse Party: Tortured Souls</title>
...
<body>
    <header>
        <script>const number = "15037";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/10/78811l.jpg" alt="Corpse Party: Tortured Souls">
                <div>
                    <h2 id="title">Corpse Party: Tortured Souls</h2>
                    <p>Mystery</p>
                    <p>2013</p>
                    <br>
                    <p>When a group of high school students perform a forbidden ritual, they find themselves transported to a haunted school where a series of gruesome murders took place. Trapped in a nightmarish world filled with vengeful spirits, the students must uncover the dark secrets of the school and find a way to escape before they become victims themselves. Time is running out as they confront the horrors lurking in the shadows, desperate to survive the deadly curse plaguing them.</p>
                </div>
            </div>
