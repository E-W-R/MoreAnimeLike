...
<head>
    ...
    <title>More Anime Like Yozakura Quartet</title>
...
<body>
    <header>
        <script>const number = "4548";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/11/74266l.jpg" alt="Yozakura Quartet">
                <div>
                    <h2 id="title">Yozakura Quartet</h2>
                    <p>Action</p>
                    <p>2008</p>
                    <br>
                    <p>In Yozakura Quartet, a group of supernatural beings, including humans with special abilities, work together in a city where humans and youkai coexist. As they navigate daily challenges and protect their town from outside threats, they discover the importance of unity and understanding between different species. The quartet faces various supernatural incidents, forming strong bonds along the way to maintain peace and harmony in their community.</p>
                </div>
            </div>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/11/61519l.webp" alt="MEKAKUCITY ACTORS">
                </div>
                <div class="details">
                    <a href="mekakucity-actors"><h3>MEKAKUCITY ACTORS</h3></a>
                    <p>Other Genre</p>
                    <p>2014</p>
                    <br>
                    <p>Set in a world where individuals possess supernatural eye abilities, a group of teenagers with these powers come together to battle mysterious forces. Led by a boy who can steal memories by making eye contact, the group navigates a complex web of secrets and danger, as they uncover the truth about their abilities and the events that bind them together. The series delves into themes of friendship, identity, and the power of connecting with others.</p>
                </div>
            </div>
