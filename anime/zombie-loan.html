...
<head>
    ...
    <title>More Anime Like Zombie-Loan</title>
...
<body>
    <header>
        <script>const number = "2404";</script>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/3/7327l.jpg" alt="Vampire Knight">
                </div>
                <div class="details">
                    <a href="vampire-knight"><h3>Vampire Knight</h3></a>
                    <p>Mystery</p>
                    <p>2008</p>
                    <br>
                    <p>Vampire Knight follows Yuki Cross, a student at Cross Academy, where vampires and humans coexist. Yuki, alongside her childhood friend Zero Kiryu, works to maintain peace between the two groups while unraveling the secrets of her own past. As she navigates her feelings for the mysterious vampire brothers, Kaname and Zero, Yuki is drawn into a complex web of love, betrayal, and dark supernatural forces. Will Yuki uncover the truth about her origins before it's too late?</p>
                </div>
            </div>
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/1474/90768l.jpg" alt="No. 6">
                </div>
                <div class="details">
                    <a href="no.-6"><h3>No. 6</h3></a>
                    <p>Mystery</p>
                    <p>2011</p>
                    <br>
                    <p>In a futuristic city called No. 6, a young boy named Shion uncovers a dark secret that puts him on the run. He forms an unlikely alliance with a fugitive named Nezumi, leading them to question the oppressive government controlling their society. As they navigate through the mysteries of their world, they must confront their own beliefs and fight for a better future.</p>
                </div>
            </div>
