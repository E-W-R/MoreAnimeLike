...
<head>
    ...
    <title>More Anime Like A Farewell to Arms</title>
...
<body>
    <header>
        <script>const number = "17677";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">A Farewell to Arms</h2>
                    <p>Action</p>
                    <p>2013</p>
                    <br>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                ...
                <div class="details">
                    <a href="flowers-of-evil"><h3>Flowers of Evil</h3></a>
                    <p>Psychological</p>
                    <p>2013</p>
                    <br>
