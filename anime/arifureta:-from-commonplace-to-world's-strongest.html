...
<head>
    ...
    <title>More Anime Like Arifureta: From Commonplace to World's Strongest</title>
...
<body>
    <header>
        <script>const number = "36882";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Arifureta: From Commonplace to World's Strongest</h2>
                    <p>Isekai</p>
                    <p>2019</p>
                    <br>
