...
<head>
    ...
    <title>More Anime Like Prétear: The New Legend of Snow White</title>
...
<body>
    <header>
        <script>const number = "100";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/9/11709l.jpg" alt="Prétear: The New Legend of Snow White">
                <div>
                    <h2 id="title">Prétear: The New Legend of Snow White</h2>
                    <p>Romance</p>
                    <p>2001</p>
                    <br>
                    <p>High school student Himeno is unexpectedly chosen as the Prétear, destined to combine her powers with skilled magical knights to save the world from the evil Princess of Disaster. Himeno must come to terms with her new powers and work alongside the Leafe Knights to protect the world from impending danger. Balancing her duties as the Prétear with her personal life, Himeno faces challenges and battles that will test her strength and determination.</p>
                </div>
            </div>
