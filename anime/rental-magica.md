...
<head>
    ...
    <title>More Anime Like Rental Magica</title>
...
<body>
    <header>
        <script>const number = "2369";</script>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/7/60263l.jpg" alt="Aldnoah.Zero">
                </div>
                <div class="details">
                    <a href="aldnoah.zero"><h3>Aldnoah.Zero</h3></a>
                    <p>Action</p>
                    <p>2014</p>
                    <br>
                    <p>In Aldnoah.Zero, two factions, Earth and Mars, find themselves on the brink of interplanetary war due to the discovery of an ancient technology called Aldnoah. As tensions escalate and battles rage between the two sides, a young Earthling soldier named Inaho Kaizuka becomes a key player in the conflict. With the fate of both worlds hanging in the balance, Inaho must use his tactical genius to outsmart the powerful Martian forces and secure a future of peace.</p>
                </div>
            </div>
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/1508/129576l.jpg" alt="OreImo">
                </div>
                <div class="details">
                    <a href="oreimo"><h3>OreImo</h3></a>
                    <p>Comedy</p>
                    <p>2010</p>
                    <br>
                    <p>After years of strained relationship, high school student Kyousuke discovers his younger sister Kirino's secret obsession with anime and eroge games. As the siblings bond over their shared interests, they navigate the struggles that come with maintaining their unusual hobby while dealing with societal judgement and family expectations. With the help of their friends, they learn more about each other and the importance of acceptance and understanding in their relationship.</p>
                </div>
            </div>
