...
<head>
    ...
    <title>More Anime Like More than a Married Couple, but Not Lovers.</title>
...
<body>
    <header>
        <script>const number = "50425";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">More than a Married Couple, but Not Lovers.</h2>
                    <p>Romance</p>
                    <p>2022</p>
                    <br>
