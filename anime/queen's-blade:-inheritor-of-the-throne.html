...
<head>
    ...
    <title>More Anime Like Queen's Blade: Inheritor of the Throne</title>
...
<body>
    <header>
        <script>const number = "6633";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Queen's Blade: Inheritor of the Throne</h2>
                    <p>Action</p>
                    <p>2009</p>
                    <br>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/2/75450l.webp" alt="The Qwaser of Stigmata II">
                </div>
                <div class="details">
                    <a href="the-qwaser-of-stigmata-ii"><h3>The Qwaser of Stigmata II</h3></a>
                    <p>Action</p>
                    <p>2011</p>
                    <br>
                    <p>In The Qwaser of Stigmata II, Mafuyu and Tomo find themselves entangled in a new conflict involving the wielders of mystical elements known as Qwaser. As they navigate the intricate web of alliances and betrayals, they uncover dark secrets that could threaten their lives and the fate of the world. With new foes and challenges ahead, Mafuyu and Tomo must harness their own powers and convictions to survive the escalating chaos.</p>
                </div>
            </div>
