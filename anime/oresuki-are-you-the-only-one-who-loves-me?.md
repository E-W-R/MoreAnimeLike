...
<head>
    ...
    <title>More Anime Like ORESUKI Are you the only one who loves me?</title>
...
<body>
    <header>
        <script>const number = "38483";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">ORESUKI Are you the only one who loves me?</h2>
                    <p>Romance</p>
                    <p>2019</p>
                    <br>
