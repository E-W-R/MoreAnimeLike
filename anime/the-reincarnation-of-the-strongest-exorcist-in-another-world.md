...
<head>
    ...
    <title>More Anime Like The Reincarnation of the Strongest Exorcist in Another World</title>
...
<body>
    <header>
        <script>const number = "50932";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">The Reincarnation of the Strongest Exorcist in Another World</h2>
                    <p>Isekai</p>
                    <p>2023</p>
                    <br>
