...
<head>
    ...
    <title>More Anime Like Shuffle! Memories</title>
...
<body>
    <header>
        <script>const number = "1836";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/4/19624l.webp" alt="Shuffle! Memories">
                <div>
                    <h2 id="title">Shuffle! Memories</h2>
                    <p>Drama</p>
                    <p>2007</p>
                    <br>
                    <p>In Shuffle! Memories, Rin Tsuchimi finds himself torn between five girls, each from a different race, as he grapples with his feelings and explores different timelines. Memories resurface, complicating the relationships. As Rin struggles to navigate his emotions and the girls around him, secrets are revealed that may change everything.</p>
                </div>
            </div>
