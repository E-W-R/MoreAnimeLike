...
<head>
    ...
    <title>More Anime Like Deltora Quest</title>
...
<body>
    <header>
        <script>const number = "1826";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/12/88164l.jpg" alt="Deltora Quest">
                <div>
                    <h2 id="title">Deltora Quest</h2>
                    <p>Other Genre</p>
                    <p>2007</p>
                    <br>
                    <p>Deltora Quest follows the journey of three companions, Lief, Barda, and Jasmine, as they set out to retrieve the lost seven magic gems of the Belt of Deltora. With the kingdom's fate hanging in the balance, they must navigate treacherous landscapes, battle dangerous creatures, and outwit the sinister Shadow Lord who seeks to plunge the land into darkness. As they face various challenges and enemies, the trio must rely on their courage, wit, and friendship to succeed in their quest.</p>
                </div>
            </div>
