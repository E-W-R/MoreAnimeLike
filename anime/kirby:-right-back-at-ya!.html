...
<head>
    ...
    <title>More Anime Like Kirby: Right Back at Ya!</title>
...
<body>
    <header>
        <script>const number = "2390";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/9/22184l.jpg" alt="Kirby: Right Back at Ya!">
                <div>
                    <h2 id="title">Kirby: Right Back at Ya!</h2>
                    <p>Action</p>
                    <p>2001</p>
                    <br>
                    <p>Kirby: Right Back at Ya! follows the adorable pink puffball Kirby as he crash-lands on the planet Popstar. Alongside his newfound friends, Kirby protects the peaceful inhabitants from various monsters and villains that threaten their home. With his ability to inhale enemies and copy their powers, Kirby faces challenges with bravery and determination, always ready to save the day with his unique skills. Join Kirby on his exciting adventures filled with friendship, fun, and plenty of action!</p>
                </div>
            </div>
