...
<head>
    ...
    <title>More Anime Like Mashiroiro Symphony: The Color of Lovers</title>
...
<body>
    <header>
        <script>const number = "10397";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Mashiroiro Symphony: The Color of Lovers</h2>
                    <p>Romance</p>
                    <p>2011</p>
                    <br>
