...
<head>
    ...
    <title>More Anime Like The Orbital Children</title>
...
<body>
    <header>
        <script>const number = "37914";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">The Orbital Children</h2>
                    <p>Other Genre</p>
                    <p>2022</p>
                    <br>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/1621/114901l.webp" alt="Eden (ONA)">
                </div>
                <div class="details">
                    <a href="eden-%28ona%29"><h3>Eden (ONA)</h3></a>
                    <p>Other Genre</p>
                    <p>2021</p>
                    <br>
                    <p>In a post-apocalyptic world inhabited only by robots, two farming robots stumble upon a human baby and decide to raise her in secret. As the girl, Sara, grows up believing she is the last human on Earth, she starts questioning the truth of her existence. When their peaceful existence is disrupted, Sara embarks on a journey to uncover the mysteries of humanity's fall and her own origins.</p>
                </div>
            </div>
