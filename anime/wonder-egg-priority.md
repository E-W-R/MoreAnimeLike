...
<head>
    ...
    <title>More Anime Like Wonder Egg Priority</title>
...
<body>
    <header>
        <script>const number = "43299";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/1079/110751l.jpg" alt="Wonder Egg Priority">
                <div>
                    <h2 id="title">Wonder Egg Priority</h2>
                    <p>Psychological</p>
                    <p>2021</p>
                    <br>
                    <p>After acquiring a mysterious egg, protagonist Ai enters a dream world where she must save girls from their darkest fears. Alongside other chosen girls, they face traumatic pasts and navigate complex emotions. As they uncover the truth behind their missions, they realize the weight of their choices and the impact on their reality. With each egg cracked, a new layer of the girls' intertwined destinies is revealed.</p>
                </div>
            </div>
