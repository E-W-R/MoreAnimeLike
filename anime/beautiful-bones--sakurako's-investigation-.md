...
<head>
    ...
    <title>More Anime Like Beautiful Bones -Sakurako's Investigation-</title>
...
<body>
    <header>
        <script>const number = "30187";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Beautiful Bones -Sakurako's Investigation-</h2>
                    <p>Mystery</p>
                    <p>2015</p>
                    <br>
