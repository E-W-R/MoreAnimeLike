...
<head>
    ...
    <title>More Anime Like The World's Finest Assassin Gets Reincarnated in Another World as an Aristocrat</title>
...
<body>
    <header>
        <script>const number = "47790";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">The World's Finest Assassin Gets Reincarnated in Another World as an Aristocrat</h2>
                    <p>Isekai</p>
                    <p>2021</p>
                    <br>
