...
<head>
    ...
    <title>More Anime Like From the New World</title>
...
<body>
    <header>
        <script>const number = "13125";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/1549/136389l.jpg" alt="From the New World">
                <div>
                    <h2 id="title">From the New World</h2>
                    <p>Mystery</p>
                    <p>2012</p>
                    <br>
                    <p>In a future society where humans possess psychic powers, Saki and her friends unravel the dark secrets lurking beneath their seemingly peaceful world. As they navigate through a complex web of mysteries, they discover the truth about their society's oppressive rules and the sinister creatures threatening their existence. With danger lurking at every corner, Saki and her friends must confront the harsh realities of their world and fight to protect their loved ones.</p>
                </div>
            </div>
