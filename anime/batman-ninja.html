...
<head>
    ...
    <title>More Anime Like Batman Ninja</title>
...
<body>
    <header>
        <script>const number = "36517";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/1351/95947l.webp" alt="Batman Ninja">
                <div>
                    <h2 id="title">Batman Ninja</h2>
                    <p>Action</p>
                    <p>2018</p>
                    <br>
                    <p>In Batman Ninja, Bruce Wayne is transported back in time to feudal Japan where he must rely on his intellect and combat skills to defeat the Joker, who has taken over as a powerful warlord. With the help of familiar allies, Batman must navigate the new environment while planning a way to return to his own time and restore order to the land. The Dark Knight faces off against his rogues' gallery in this epic clash of historical proportions.</p>
                </div>
            </div>
