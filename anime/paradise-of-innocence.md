...
<head>
    ...
    <title>More Anime Like Paradise of Innocence</title>
...
<body>
    <header>
        <script>const number = "23423";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/5/74733l.jpg" alt="Paradise of Innocence">
                <div>
                    <h2 id="title">Paradise of Innocence</h2>
                    <p>Romance</p>
                    <p>2014</p>
                    <br>
                    <p>In the peaceful town of Serenity, mysterious disappearances begin to plague the community. A group of high school students embark on a journey to uncover the truth behind the vanishing residents. As they delve deeper into the secrets of the town, they realize that Serenity holds dark and sinister secrets that threaten their very existence. The students must now confront their own fears and unravel the mystery before it's too late.</p>
                </div>
            </div>
