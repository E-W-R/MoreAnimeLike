...
<head>
    ...
    <title>More Anime Like My Mental Choices Are Completely Interfering With My School Romantic Comedy</title>
...
<body>
    <header>
        <script>const number = "19221";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">My Mental Choices Are Completely Interfering With My School Romantic Comedy</h2>
                    <p>Romance</p>
                    <p>2013</p>
                    <br>
