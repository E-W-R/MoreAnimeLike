...
<head>
    ...
    <title>More Anime Like Tsurune: Kazemai High School Kyudo Club</title>
...
<body>
    <header>
        <script>const number = "36653";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Tsurune: Kazemai High School Kyudo Club</h2>
                    <p>Sports</p>
                    <p>2018</p>
                    <br>
