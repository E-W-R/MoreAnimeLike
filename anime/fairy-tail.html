...
<head>
    ...
    <title>More Anime Like Fairy Tail</title>
...
<body>
    <header>
        <script>const number = "6702";</script>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/1708/107833l.webp" alt="Hyperventilation">
                </div>
                <div class="details">
                    <a href="hyperventilation"><h3>Hyperventilation</h3></a>
                    <p>Drama</p>
                    <p>2017</p>
                    <br>
                    <p>Hyperventilation follows the story of Myeong, a struggling art student, who crosses paths with a successful author named Shin. As they grow closer, Myeong finds himself drawn to Shin, but their blossoming relationship is fraught with challenges and misunderstandings. As they navigate their feelings for each other, both men must confront their pasts and insecurities to find a way to be together.</p>
                </div>
            </div>
