...
<head>
    ...
    <title>More Anime Like The Weakest Tamer Began a Journey to Pick Up Trash</title>
...
<body>
    <header>
        <script>const number = "53590";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">The Weakest Tamer Began a Journey to Pick Up Trash</h2>
                    <p>Isekai</p>
                    <p>2024</p>
                    <br>
