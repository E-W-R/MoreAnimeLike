...
<head>
    ...
    <title>More Anime Like Assassins Pride</title>
...
<body>
    <header>
        <script>const number = "38572";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Assassins Pride</h2>
                    <p>Other Genre</p>
                    <p>2019</p>
                    <br>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/5/38329l.jpg" alt="Shining Hearts: Shiawase no Pan">
                </div>
                <div class="details">
                    <a href="shining-hearts%3A-shiawase-no-pan"><h3>Shining Hearts: Shiawase no Pan</h3></a>
                    <p>Isekai</p>
                    <p>2012</p>
                    <br>
                    <p>In the peaceful island of Windaria, a mysterious girl washes ashore with no memories except for her skill in baking bread. Soon, she becomes entangled with the lives of three adventurers who run a bakery. As they work together to help the girl recover her memories, they uncover a dark secret that threatens to disrupt the tranquility of their island paradise. The group must band together to protect their home and each other from impending danger.</p>
                </div>
            </div>
