...
<head>
    ...
    <title>More Anime Like Yu-Gi-Oh!</title>
...
<body>
    <header>
        <script>const number = "481";</script>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/1180/133782l.jpg" alt="Saint Seiya: Knights of the Zodiac">
                </div>
                <div class="details">
                    <a href="saint-seiya%3A-knights-of-the-zodiac"><h3>Saint Seiya: Knights of the Zodiac</h3></a>
                    <p>Action</p>
                    <p>1986</p>
                    <br>
                    <p>Saint Seiya: Knights of the Zodiac follows a group of young warriors known as the Saints who are sworn to protect the reincarnation of the Greek goddess Athena in her fight against evil forces. Each Saint wears a sacred armor based on a constellation and possesses unique abilities granted by the cosmos. Together, they embark on dangerous missions and epic battles to defend Athena and uphold justice in the name of peace.</p>
                </div>
            </div>
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/1429/137275l.jpg" alt="Maboroshi">
                </div>
                <div class="details">
                    <a href="maboroshi"><h3>Maboroshi</h3></a>
                    <p>Drama</p>
                    <p>2023</p>
                    <br>
                    <p>Maboroshi follows the story of a young girl who discovers a hidden power within herself that allows her to manipulate shadows. As she delves deeper into this mysterious ability, she uncovers a dark secret that threatens the balance of her world. With the help of her friends, she must navigate through treacherous challenges to safeguard her loved ones and prevent chaos from consuming everything she holds dear.</p>
                </div>
            </div>
