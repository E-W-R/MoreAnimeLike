...
<head>
    ...
    <title>More Anime Like Crest of the Stars</title>
...
<body>
    <header>
        <script>const number = "290";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/1585/99289l.jpg" alt="Crest of the Stars">
                <div>
                    <h2 id="title">Crest of the Stars</h2>
                    <p>Romance</p>
                    <p>1999</p>
                    <br>
                    <p>In Crest of the Stars, young Jinto is thrust into a galactic war when his home planet is taken over by the Abh Empire. Captured by the Abh, he befriends the noble princess Lafiel as they navigate political intrigue and military conflicts. Together, they must forge a unique bond to survive the turbulent times and discover their places in the vast universe.</p>
                </div>
            </div>
