...
<head>
    ...
    <title>More Anime Like Dr. Ramune -Mysterious Disease Specialist-</title>
...
<body>
    <header>
        <script>const number = "42822";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Dr. Ramune -Mysterious Disease Specialist-</h2>
                    <p>Mystery</p>
                    <p>2021</p>
                    <br>
