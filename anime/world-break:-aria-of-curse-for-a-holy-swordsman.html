...
<head>
    ...
    <title>More Anime Like World Break: Aria of Curse for a Holy Swordsman</title>
...
<body>
    <header>
        <script>const number = "22663";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">World Break: Aria of Curse for a Holy Swordsman</h2>
                    <p>Romance</p>
                    <p>2015</p>
                    <br>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                ...
                <div class="details">
                    <a href="argevollen"><h3>Argevollen</h3></a>
                    <p>Action</p>
                    <p>2014</p>
                    <br>
