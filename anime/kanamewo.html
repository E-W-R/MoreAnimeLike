...
<head>
    ...
    <title>More Anime Like Kanamewo</title>
...
<body>
    <header>
        <script>const number = "32287";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/7/83455l.jpg" alt="Kanamewo">
                <div>
                    <h2 id="title">Kanamewo</h2>
                    <p>Drama</p>
                    <p>2015</p>
                    <br>
                    <p>Kanamewo follows a girl with a mysterious ability: when she looks someone directly in the eyes, she can see moments of their past. Conflicted by what she witnesses, she struggles with whether to intervene in the lives of those around her. As she navigates this unusual power, she grapples with the consequences of delving into the private histories of others.</p>
                </div>
            </div>
