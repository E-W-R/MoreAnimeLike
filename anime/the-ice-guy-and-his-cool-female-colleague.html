...
<head>
    ...
    <title>More Anime Like The Ice Guy and His Cool Female Colleague</title>
...
<body>
    <header>
        <script>const number = "52173";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">The Ice Guy and His Cool Female Colleague</h2>
                    <p>Romance</p>
                    <p>2023</p>
                    <br>
