...
<head>
    ...
    <title>More Anime Like The Genius Prince's Guide to Raising a Nation Out of Debt</title>
...
<body>
    <header>
        <script>const number = "47159";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">The Genius Prince's Guide to Raising a Nation Out of Debt</h2>
                    <p>Comedy</p>
                    <p>2022</p>
                    <br>
