...
<head>
    ...
    <title>More Anime Like Monster Musume: Everyday Life with Monster Girls</title>
...
<body>
    <header>
        <script>const number = "30307";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Monster Musume: Everyday Life with Monster Girls</h2>
                    <p>Comedy</p>
                    <p>2015</p>
                    <br>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                ...
                <div class="details">
                    <a href="mechanical-arms"><h3>Mechanical Arms</h3></a>
                    <p>Action</p>
                    <p>2018</p>
                    <br>
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/2/50375l.jpg" alt="Linebarrels of Iron">
                </div>
                <div class="details">
                    <a href="linebarrels-of-iron"><h3>Linebarrels of Iron</h3></a>
                    <p>Action</p>
                    <p>2008</p>
                    <br>
                    <p>Kouichi Hayase's life changes when he encounters a mysterious mecha, Linebarrel, which grants him immense power. As he becomes a reluctant hero involved in a war between secret organizations and alien invaders, Kouichi must navigate his newfound abilities while uncovering the truth behind the Linebarrel and his own past. With the fate of the world at stake, Kouichi must decide how to wield his power responsibly.</p>
                </div>
            </div>
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/12/84421l.webp" alt="ID-0">
                </div>
                <div class="details">
                    <a href="id-0"><h3>ID-0</h3></a>
                    <p>Other Genre</p>
                    <p>2017</p>
                    <br>
                    <p>In ID-0, a group of miners aboard the spaceship Excavate One accidentally discover an ancient alien technology that allows a person's consciousness to be transferred into a robot body. When the ship is attacked, rookie pilot Maya finds herself linked to an AI-controlled robot miner named I-Machines. Together, they must navigate through dangerous space missions and unravel the mystery behind the powerful technology known as Orichalt.</p>
                </div>
            </div>
