...
<head>
    ...
    <title>More Anime Like Samurai Deeper Kyo</title>
...
<body>
    <header>
        <script>const number = "419";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/4/23744l.jpg" alt="Samurai Deeper Kyo">
                <div>
                    <h2 id="title">Samurai Deeper Kyo</h2>
                    <p>Comedy</p>
                    <p>2002</p>
                    <br>
                    <p>In a world torn by war, a feared samurai known as Demon Eyes Kyo wanders in search of his true enemy, the one who sealed his powers. Along the way, he crosses paths with a skilled and mysterious young female bounty hunter named Yuya, who becomes entangled in his quest for revenge. As they journey together, they encounter powerful foes and uncover dark secrets from Kyo's past, leading to an epic showdown that will determine the fate of the land.</p>
                </div>
            </div>
