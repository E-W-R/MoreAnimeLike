...
<head>
    ...
    <title>More Anime Like March Comes In Like a Lion</title>
...
<body>
    <header>
        <script>const number = "31646";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">March Comes In Like a Lion</h2>
                    <p>Drama</p>
                    <p>2016</p>
                    <br>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/11/75274l.webp" alt="Bakemonogatari">
                </div>
                <div class="details">
                    <a href="bakemonogatari"><h3>Bakemonogatari</h3></a>
                    <p>Mystery</p>
                    <p>2009</p>
                    <br>
                    <p>Bakemonogatari follows high school student Koyomi Araragi as he gets involved with various female students struggling with supernatural afflictions. With the help of a talented young vampire, he navigates a world of oddities and mysteries to help these girls facing paranormal challenges. Together, they work to unravel the secrets behind these supernatural phenomena while forming deep connections with each other.</p>
                </div>
            </div>
