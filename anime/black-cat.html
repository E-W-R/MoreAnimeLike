...
<head>
    ...
    <title>More Anime Like Black Cat</title>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/8/38383l.jpg" alt="MÄR">
                </div>
                <div class="details">
                    <a href="m%C3%A4r"><h3>MÄR</h3></a>
                    <p>Isekai</p>
                    <p>2005</p>
                    <br>
                    <p>Ginta, a young boy fascinated with the fantasy world of MÄR Heaven, gets transported there where he discovers he is a chosen hero meant to save the land from an evil tyrant. With the help of new friends and powerful ÄRMs weapons, Ginta embarks on a journey to defeat the Chess Pieces and their leader, the sinister Phantom. As he battles through various challenges and opponents, Ginta's courage and determination are put to the test.</p>
                </div>
            </div>
