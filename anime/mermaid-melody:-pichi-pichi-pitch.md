...
<head>
    ...
    <title>More Anime Like Mermaid Melody: Pichi Pichi Pitch</title>
...
<body>
    <header>
        <script>const number = "521";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/3/9640l.jpg" alt="Mermaid Melody: Pichi Pichi Pitch">
                <div>
                    <h2 id="title">Mermaid Melody: Pichi Pichi Pitch</h2>
                    <p>Comedy</p>
                    <p>2003</p>
                    <br>
                    <p>Mermaid Melody: Pichi Pichi Pitch follows the story of Lucia, a mermaid princess who comes to land to find love and the powerful pearls that will save her underwater kingdom. Alongside her friends, Lucia uses her magical singing voice to fight against evil sea creatures and the schemes of the sea witch, in hopes of bringing peace to both the ocean and the human world.</p>
                </div>
            </div>
