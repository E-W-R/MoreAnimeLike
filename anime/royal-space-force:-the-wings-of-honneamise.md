...
<head>
    ...
    <title>More Anime Like Royal Space Force: The Wings of Honneamise</title>
...
<body>
    <header>
        <script>const number = "1034";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Royal Space Force: The Wings of Honneamise</h2>
                    <p>Action</p>
                    <p>1987</p>
                    <br>
