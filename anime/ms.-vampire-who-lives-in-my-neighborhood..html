...
<head>
    ...
    <title>More Anime Like Ms. Vampire who lives in my neighborhood.</title>
...
<body>
    <header>
        <script>const number = "37579";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Ms. Vampire who lives in my neighborhood.</h2>
                    <p>Comedy</p>
                    <p>2018</p>
                    <br>
