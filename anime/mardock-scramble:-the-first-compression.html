...
<head>
    ...
    <title>More Anime Like Mardock Scramble: The First Compression</title>
...
<body>
    <header>
        <script>const number = "8100";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Mardock Scramble: The First Compression</h2>
                    <p>Psychological</p>
                    <p>2010</p>
                    <br>
