...
<head>
    ...
    <title>More Anime Like Stella Women's Academy, High School Division Class C³</title>
...
<body>
    <header>
        <script>const number = "17821";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Stella Women's Academy, High School Division Class C³</h2>
                    <p>Sports</p>
                    <p>2013</p>
                    <br>
