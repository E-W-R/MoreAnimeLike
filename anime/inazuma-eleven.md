...
<head>
    ...
    <title>More Anime Like Inazuma Eleven</title>
...
<body>
    <header>
        <script>const number = "5231";</script>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/1121/117792l.jpg" alt="Sgt. Frog">
                </div>
                <div class="details">
                    <a href="sgt.-frog"><h3>Sgt. Frog</h3></a>
                    <p>Comedy</p>
                    <p>2004</p>
                    <br>
                    <p>When five frog-like aliens arrive on Earth with a mission to conquer the planet, they find themselves living with the Hinata family instead. Keroro, the leader, struggles to balance his invasion plans with daily life antics, joined by the rest of the quirky alien squad. As they face challenges and enemies from their past, the group forms strong bonds with the humans around them. Together, they navigate the chaos of both intergalactic warfare and everyday adventures.</p>
                </div>
            </div>
