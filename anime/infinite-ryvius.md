...
<head>
    ...
    <title>More Anime Like Infinite Ryvius</title>
...
<body>
    <header>
        <script>const number = "593";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/3/16734l.jpg" alt="Infinite Ryvius">
                <div>
                    <h2 id="title">Infinite Ryvius</h2>
                    <p>Psychological</p>
                    <p>1999</p>
                    <br>
                    <p>Infinite Ryvius follows a group of space cadets stranded aboard the Ryvius spaceship after a sudden attack leaves them alone in space. With no adults present, the cadets must work together to survive and navigate their way back to Earth. As tensions rise and resources dwindle, they must face internal struggles and external threats in order to make it home safely.</p>
                </div>
            </div>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/1094/109008l.webp" alt="Now and Then, Here and There">
                </div>
                <div class="details">
                    <a href="now-and-then%2C-here-and-there"><h3>Now and Then, Here and There</h3></a>
                    <p>Isekai</p>
                    <p>1999</p>
                    <br>
                    <p>Shu is transported to a bleak world where war reigns and water is scarce. He meets Lala-Ru, a mysterious girl with the power to control water. Shu gets caught up in the conflict, determined to rescue Lala-Ru from the ruthless dictator Hamdo. Amidst the chaos and despair, Shu's unwavering hope shines through as he fights to protect those he cares about in a harsh and unforgiving world.</p>
                </div>
            </div>
