...
<head>
    ...
    <title>More Anime Like Japan Sinks: 2020</title>
...
<body>
    <header>
        <script>const number = "40515";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/1989/107335l.jpg" alt="Japan Sinks: 2020">
                <div>
                    <h2 id="title">Japan Sinks: 2020</h2>
                    <p>Drama</p>
                    <p>2020</p>
                    <br>
                    <p>After a series of natural disasters strike Japan, a family must navigate the chaos and destruction in order to survive. With the country sinking into the ocean, the family encounters various challenges and meets new friends along the way as they struggle to find a way to safety. The series follows their journey, highlighting the resilience and determination of the human spirit in the face of tragedy.</p>
                </div>
            </div>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                ...
                <div class="details">
                    <a href="ni-no-kuni"><h3>Ni no Kuni</h3></a>
                    <p>Isekai</p>
                    <p>2019</p>
                    <br>
