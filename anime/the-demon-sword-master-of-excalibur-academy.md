...
<head>
    ...
    <title>More Anime Like The Demon Sword Master of Excalibur Academy</title>
...
<body>
    <header>
        <script>const number = "50184";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">The Demon Sword Master of Excalibur Academy</h2>
                    <p>Action</p>
                    <p>2023</p>
                    <br>
