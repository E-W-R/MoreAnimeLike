...
<head>
    ...
    <title>More Anime Like Ceres, Celestial Legend</title>
...
<body>
    <header>
        <script>const number = "104";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Ceres, Celestial Legend</h2>
                    <p>Psychological</p>
                    <p>2000</p>
                    <br>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                ...
                <div class="details">
                    <a href="bokura-ga-ita"><h3>Bokura ga Ita</h3></a>
                    <p>Romance</p>
                    <p>2006</p>
                    <br>
