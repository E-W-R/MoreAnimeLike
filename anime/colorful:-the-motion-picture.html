...
<head>
    ...
    <title>More Anime Like Colorful: The Motion Picture</title>
...
<body>
    <header>
        <script>const number = "8142";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Colorful: The Motion Picture</h2>
                    <p>Drama</p>
                    <p>2010</p>
                    <br>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/9/77062l.webp" alt="Fantastic Children">
                </div>
                <div class="details">
                    <a href="fantastic-children"><h3>Fantastic Children</h3></a>
                    <p>Mystery</p>
                    <p>2004</p>
                    <br>
                    <p>Fantastic Children follows a group of mysterious children who possess otherworldly abilities and do not age. As they search for a girl from their past, they encounter various individuals and challenges that will test their resolve. The series weaves together elements of fantasy, science fiction, and mystery as the children's true origins and the significance of their reunion gradually unfold.</p>
                </div>
            </div>
