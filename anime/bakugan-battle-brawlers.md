...
<head>
    ...
    <title>More Anime Like Bakugan Battle Brawlers</title>
...
<body>
    <header>
        <script>const number = "2156";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Bakugan Battle Brawlers</h2>
                    <p>Action</p>
                    <p>2007</p>
                    <br>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/10/75397l.jpg" alt="Dinosaur King">
                </div>
                <div class="details">
                    <a href="dinosaur-king"><h3>Dinosaur King</h3></a>
                    <p>Other Genre</p>
                    <p>2007</p>
                    <br>
                    <p>Dinosaur King follows the adventures of three kids who discover special stone fossils that allow them to summon dinosaurs. As they travel back in time, they must protect the dinosaurs from an evil group who want to use them for their own gain. Together, the trio battles villains and solves mysteries to ensure the safety of the dinosaurs and the world.</p>
                </div>
            </div>
            ...
            <div class="recommendation">
                ...
                <div class="details">
                    <a href="duel-masters"><h3>Duel Masters</h3></a>
                    <p>Action</p>
                    <p>2002</p>
                    <br>
