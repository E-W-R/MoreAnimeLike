...
<head>
    ...
    <title>More Anime Like Arashi no Yoru ni</title>
...
<body>
    <header>
        <script>const number = "1961";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/9/5064l.jpg" alt="Arashi no Yoru ni">
                <div>
                    <h2 id="title">Arashi no Yoru ni</h2>
                    <p>Drama</p>
                    <p>2005</p>
                    <br>
                    <p>When a wolf and a goat unexpectedly become friends, they must keep their bond hidden from their respective animal communities. As they meet in secret, they find similarities in their struggles and realize that friendship can transcend even the deepest differences. However, their unlikely alliance is put to the test when their true identities are revealed. Will their friendship withstand the challenges that come with it?</p>
                </div>
            </div>
