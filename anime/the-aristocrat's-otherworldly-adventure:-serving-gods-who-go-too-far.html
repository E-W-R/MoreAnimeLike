...
<head>
    ...
    <title>More Anime Like The Aristocrat's Otherworldly Adventure: Serving Gods Who Go Too Far</title>
...
<body>
    <header>
        <script>const number = "52608";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">The Aristocrat's Otherworldly Adventure: Serving Gods Who Go Too Far</h2>
                    <p>Isekai</p>
                    <p>2023</p>
                    <br>
