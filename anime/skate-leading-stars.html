...
<head>
    ...
    <title>More Anime Like Skate-Leading Stars</title>
...
<body>
    <header>
        <script>const number = "40786";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Skate-Leading Stars</h2>
                    <p>Sports</p>
                    <p>2021</p>
                    <br>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                ...
                <div class="details">
                    <a href="platinum-end"><h3>Platinum End</h3></a>
                    <p>Psychological</p>
                    <p>2021</p>
                    <br>
