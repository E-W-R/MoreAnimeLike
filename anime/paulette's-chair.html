...
<head>
    ...
    <title>More Anime Like Paulette's Chair</title>
...
<body>
    <header>
        <script>const number = "23285";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/13/60739l.jpg" alt="Paulette's Chair">
                <div>
                    <h2 id="title">Paulette's Chair</h2>
                    <p>Other Genre</p>
                    <p>2014</p>
                    <br>
                    <p>Paulette's Chair follows the story of a young girl named Paulette who discovers an old, mysterious chair in her attic. Little does she know that sitting on this chair transports her to a magical world filled with talking animals and hidden dangers. With the help of her new animal friends, Paulette embarks on a thrilling adventure to uncover the secrets of the chair and find her way back home.</p>
                </div>
            </div>
