...
<head>
    ...
    <title>More Anime Like Kamichu!</title>
...
<body>
    <header>
        <script>const number = "489";</script>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/13/4907l.webp" alt="Gakuen Utopia Manabi Straight!">
                </div>
                <div class="details">
                    <a href="gakuen-utopia-manabi-straight%21"><h3>Gakuen Utopia Manabi Straight!</h3></a>
                    <p>Comedy</p>
                    <p>2007</p>
                    <br>
                    <p>In a futuristic world where the birthrate has plummeted, a group of high school girls work to revitalize their school and promote a positive atmosphere through exciting events and new clubs. Manami Amamiya, a new student, joins in their efforts to bring a sense of joy and hope to their school. As they face challenges and setbacks, the girls learn the importance of friendship, perseverance, and working together towards a common goal.</p>
                </div>
            </div>
