...
<head>
    ...
    <title>More Anime Like Extra Olympia Kyklos</title>
...
<body>
    <header>
        <script>const number = "41266";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/1783/113441l.jpg" alt="Extra Olympia Kyklos">
                <div>
                    <h2 id="title">Extra Olympia Kyklos</h2>
                    <p>Sports</p>
                    <p>2020</p>
                    <br>
                    <p>In Extra Olympia Kyklos, a young man named Demetrios unwillingly gets transported back in time to ancient Greece during the Olympic Games. Despite his confusion and disbelief, Demetrios must adapt to his new surroundings, interact with historical figures, and participate in the games to find a way back to his own time. With his modern knowledge and eccentric personality, Demetrios navigates the challenges of the ancient world in this comedic and fish-out-of-water anime series.</p>
                </div>
            </div>
