...
<head>
    ...
    <title>More Anime Like Kyou kara Maou!</title>
...
<body>
    <header>
        <script>const number = "251";</script>
    ...
    <main>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                ...
                <div class="details">
                    <a href="ef---a-tale-of-memories."><h3>ef - a tale of memories.</h3></a>
                    <p>Mystery</p>
                    <p>2007</p>
                    <br>
