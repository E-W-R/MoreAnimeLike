...
<head>
    ...
    <title>More Anime Like Danganronpa: The Animation</title>
...
<body>
    <header>
        <script>const number = "16592";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Danganronpa: The Animation</h2>
                    <p>Mystery</p>
                    <p>2013</p>
                    <br>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/1329/116479l.jpg" alt="Levius">
                </div>
                <div class="details">
                    <a href="levius"><h3>Levius</h3></a>
                    <p>Sports</p>
                    <p>2019</p>
                    <br>
                    <p>In a world where mech battles determine power and status, Levius Cromwell enters the brutal arena to seek redemption and uncover the truth behind his traumatic past. With the support of his friends and coach, Levius must navigate the dangerous world of cybernetic enhancements and fierce opponents as he fights his way to the top. Balancing his humanity with the relentless demands of the ring, Levius must ultimately decide what he is truly fighting for.</p>
                </div>
            </div>
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/1869/104422l.jpg" alt="Uncharted Walker">
                </div>
                <div class="details">
                    <a href="uncharted-walker"><h3>Uncharted Walker</h3></a>
                    <p>Mystery</p>
                    <p>2018</p>
                    <br>
                    <p>In a world where fantastical creatures roam the land, a young adventurer sets out on a daring journey to explore ancient ruins and uncover hidden treasures. Guided by a mysterious compass that leads him to uncharted territories, he must navigate through perilous terrain, battle formidable foes, and ultimately discover the truth behind his own enigmatic past. Joined by a diverse group of allies, each with their own unique abilities, they face thrilling challenges and forge unbreakable bonds on their quest for discovery.</p>
                </div>
            </div>
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/5/73999l.jpg" alt="Rental Magica">
                </div>
                <div class="details">
                    <a href="rental-magica"><h3>Rental Magica</h3></a>
                    <p>Mystery</p>
                    <p>2007</p>
                    <br>
                    <p>After his parents' disappearance, Itsuki Iba inherits the Astral Detective Agency, specializing in supernatural cases. With the help of his team of mages, they tackle various dangerous assignments to help both humans and spirits. Itsuki must navigate the complex world of magic while facing personal challenges and uncovering the truth behind his parents' mysterious vanishing.</p>
                </div>
            </div>
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/3/76125l.jpg" alt="Young Black Jack">
                </div>
                <div class="details">
                    <a href="young-black-jack"><h3>Young Black Jack</h3></a>
                    <p>Drama</p>
                    <p>2015</p>
                    <br>
                    <p>Child prodigy Dr. Kuroo Hazama navigates the murky waters of the medical world during the 1960s. Known for his unconventional methods, he confronts various medical cases while grappling with his own beliefs and morals. Through these experiences, he strives to save lives and challenge the flawed system, all while keeping his own turbulent past hidden. This series delves into the origins of the legendary Black Jack and his journey towards becoming the enigmatic surgeon known to many.</p>
                </div>
            </div>
