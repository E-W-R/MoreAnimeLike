...
<head>
    ...
    <title>More Anime Like Rumbling Hearts</title>
...
<body>
    <header>
        <script>const number = "147";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/5/10227l.jpg" alt="Rumbling Hearts">
                <div>
                    <h2 id="title">Rumbling Hearts</h2>
                    <p>Romance</p>
                    <p>2003</p>
                    <br>
                    <p>After a tragic accident leaves a young couple torn apart, they must navigate through heartbreak and emotional turmoil. As time passes, they find themselves surrounded by new relationships and unexpected challenges that test their feelings for each other. Amidst the confusion of love and loyalty, they must decide whether to follow their hearts or let go of the past.</p>
                </div>
            </div>
