...
<head>
    ...
    <title>More Anime Like Pui Pui Molcar</title>
...
<body>
    <header>
        <script>const number = "44235";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/1484/119197l.jpg" alt="Pui Pui Molcar">
                <div>
                    <h2 id="title">Pui Pui Molcar</h2>
                    <p>Comedy</p>
                    <p>2021</p>
                    <br>
                    <p>Pui Pui Molcar follows the adorable and mischievous Molcars, a group of guinea pig-like cars with the unique ability to transform into small, round vehicles. Each episode showcases their everyday adventures and antics as they navigate their miniature world. With its charming characters and lighthearted storyline, Pui Pui Molcar is a heartwarming and fun-filled anime that appeals to viewers of all ages.</p>
                </div>
            </div>
