...
<head>
    ...
    <title>More Anime Like Scar on the Praeter</title>
...
<body>
    <header>
        <script>const number = "42825";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/1239/111647l.jpg" alt="Scar on the Praeter">
                <div>
                    <h2 id="title">Scar on the Praeter</h2>
                    <p>Action</p>
                    <p>2021</p>
                    <br>
                    <p>In a world where magic is a fundamental part of society, a young mage named Elena discovers a mysterious scar on her body that grants her incredible power. As she navigates a dangerous and complex magical society, she must uncover the truth behind her newfound abilities and confront the dark forces that seek to control her. With the help of her friends, Elena embarks on a journey filled with betrayal, secrets, and powerful adversaries that will test her strength and determination.</p>
                </div>
            </div>
