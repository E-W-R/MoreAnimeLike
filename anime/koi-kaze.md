...
<head>
    ...
    <title>More Anime Like Koi Kaze</title>
...
<body>
    <header>
        <script>const number = "634";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/9/61441l.jpg" alt="Koi Kaze">
                <div>
                    <h2 id="title">Koi Kaze</h2>
                    <p>Psychological</p>
                    <p>2004</p>
                    <br>
                    <p>Koi Kaze follows Koshiro, a 27-year-old man struggling with his job and relationships. When he meets his younger sister, Nanoka, for the first time in years, they develop a close bond. However, their relationship takes a challenging turn as they both realize their feelings are more than just sibling love. As they navigate their forbidden emotions, they must come to terms with societal norms, personal boundaries, and the complexity of their connection.</p>
                </div>
            </div>
