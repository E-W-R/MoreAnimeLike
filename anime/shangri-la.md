...
<head>
    ...
    <title>More Anime Like Shangri-La</title>
...
<body>
    <header>
        <script>const number = "5220";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/1780/121358l.webp" alt="Shangri-La">
                <div>
                    <h2 id="title">Shangri-La</h2>
                    <p>Action</p>
                    <p>2009</p>
                    <br>
                    <p>In a post-apocalyptic world where climate change has ravaged the planet, a young girl named Kuniko is determined to overthrow the authoritarian government ruling over the remaining population. With the help of her friends, Kuniko joins a rebel group and fights for freedom and justice as they uncover dark secrets and conspiracies that threaten their existence. As the group embarks on their mission to create a new world, they must navigate political intrigue, betrayal, and the harsh realities of their environment.</p>
                </div>
            </div>
