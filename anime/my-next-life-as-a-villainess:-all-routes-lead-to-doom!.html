...
<head>
    ...
    <title>More Anime Like My Next Life as a Villainess: All Routes Lead to Doom!</title>
...
<body>
    <header>
        <script>const number = "38555";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">My Next Life as a Villainess: All Routes Lead to Doom!</h2>
                    <p>Isekai</p>
                    <p>2020</p>
                    <br>
