...
<head>
    ...
    <title>More Anime Like Record of Lodoss War</title>
...
<body>
    <header>
        <script>const number = "207";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Record of Lodoss War</h2>
                    <p>Action</p>
                    <p>1990</p>
                    <br>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/12/81588l.jpg" alt="The Kubikiri Cycle">
                </div>
                <div class="details">
                    <a href="the-kubikiri-cycle"><h3>The Kubikiri Cycle</h3></a>
                    <p>Mystery</p>
                    <p>2016</p>
                    <br>
                    <p>The Kubikiri Cycle follows a bizarre series of murders taking place on a secluded island. When a mysterious genius and a group of eccentric individuals are invited to solve the case, they soon find themselves trapped in a deadly game of wits. As the body count rises, they must unravel the tangled web of secrets and lies surrounding the enigmatic murders before they become the next victims.</p>
                </div>
            </div>
