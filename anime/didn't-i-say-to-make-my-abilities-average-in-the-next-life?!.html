...
<head>
    ...
    <title>More Anime Like Didn't I Say to Make My Abilities Average in the Next Life?!</title>
...
<body>
    <header>
        <script>const number = "37393";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Didn't I Say to Make My Abilities Average in the Next Life?!</h2>
                    <p>Isekai</p>
                    <p>2019</p>
                    <br>
