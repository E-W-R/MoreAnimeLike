...
<head>
    ...
    <title>More Anime Like Samurai 7</title>
...
<body>
    <header>
        <script>const number = "166";</script>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/1293/115173l.jpg" alt="The Idaten Deities Know Only Peace">
                </div>
                <div class="details">
                    <a href="the-idaten-deities-know-only-peace"><h3>The Idaten Deities Know Only Peace</h3></a>
                    <p>Action</p>
                    <p>2021</p>
                    <br>
                    <p>In a world devastated by war, the Idaten deities, powerful warriors who bring peace, have been sealed away for millennia. When a young girl accidentally awakens them, they must navigate a new era of advanced technology and conflicting ideologies to fulfill their duty. As they struggle to understand this modern world, they must come to terms with their own violent history and find a way to bring about peace once again.</p>
                </div>
            </div>
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/1247/121345l.jpg" alt="Tomodachi Game">
                </div>
                <div class="details">
                    <a href="tomodachi-game"><h3>Tomodachi Game</h3></a>
                    <p>Psychological</p>
                    <p>2022</p>
                    <br>
                    <p>Tomodachi Game follows a group of high school friends who are forced to participate in a twisted game where they must complete increasingly cruel and dangerous tasks to win a large sum of money. As the game progresses, trust and loyalty are tested, and the true nature of each character is revealed. Betrayal and suspense take center stage as the friends struggle to survive the ruthless challenges and uncover the mastermind behind the sadistic game.</p>
                </div>
            </div>
