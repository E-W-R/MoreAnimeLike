...
<head>
    ...
    <title>More Anime Like Wakakozake</title>
...
<body>
    <header>
        <script>const number = "30437";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/9/76018l.jpg" alt="Wakakozake">
                <div>
                    <h2 id="title">Wakakozake</h2>
                    <p>Other Genre</p>
                    <p>2015</p>
                    <br>
                    <p>Wakakozake follows the daily life of a young office lady named Murasaki Wakako who enjoys dining out alone after work. Each episode features Wakako visiting various restaurants and izakayas to savor delicious food and drinks, taking the audience on a culinary journey through Japan. With her simple yet profound appreciation for food, Wakako's adventures showcase her love for the unique experience of dining alone.</p>
                </div>
            </div>
