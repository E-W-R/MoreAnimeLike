...
<head>
    ...
    <title>More Anime Like HenSemi (TV)</title>
...
<body>
    <header>
        <script>const number = "10187";</script>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/1484/93140l.jpg" alt="Back Street Girls: Gokudols">
                </div>
                <div class="details">
                    <a href="back-street-girls%3A-gokudols"><h3>Back Street Girls: Gokudols</h3></a>
                    <p>Comedy</p>
                    <p>2018</p>
                    <br>
                    <p>After failing their yakuza boss one too many times, three men are given a choice - undergo a sex change operation and become idols to make money for their boss, or face death. Now transformed into women, these former yakuza members must navigate the cutthroat world of show business while hiding their true identities. Comedy ensues as they struggle to balance their new lives as idol singers with their past as ruthless gangsters.</p>
                </div>
            </div>
