...
<head>
    ...
    <title>More Anime Like Go! Go! Loser Ranger!</title>
...
<body>
    <header>
        <script>const number = "53770";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Go! Go! Loser Ranger!</h2>
                    <p>Action</p>
                    <p>2024</p>
                    <br>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/1807/103081l.jpg" alt="Stars Align">
                </div>
                <div class="details">
                    <a href="stars-align"><h3>Stars Align</h3></a>
                    <p>Sports</p>
                    <p>2019</p>
                    <br>
                    <p>Stars Align follows a middle school boys' soft tennis team as they face personal struggles both on and off the court. The team is determined to compete in the national championship, but each member harbors their own secrets and past traumas that threaten to tear them apart. As they navigate friendship, family, and identity, the boys must learn to work together and support each other if they want to achieve success in the tournament.</p>
                </div>
            </div>
