...
<head>
    ...
    <title>More Anime Like My Home Hero</title>
...
<body>
    <header>
        <script>const number = "52092";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/1525/132959l.webp" alt="My Home Hero">
                <div>
                    <h2 id="title">My Home Hero</h2>
                    <p>Drama</p>
                    <p>2023</p>
                    <br>
                    <p>When a timid salesman finds a kidnapped teenage girl in his kitchen, he decides to save her. As he quickly becomes aware of her difficult situation, he takes it upon himself to protect her from her dangerous captors. In order to do so, he must embrace his hidden past as a skilled ex-yakuza member, using his expertise to outsmart his enemies and ensure the girl's safety. The story unfolds as he navigates through this dangerous world, risking everything to keep her safe.</p>
                </div>
            </div>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/2/23457l.jpg" alt="Needless">
                </div>
                <div class="details">
                    <a href="needless"><h3>Needless</h3></a>
                    <p>Action</p>
                    <p>2009</p>
                    <br>
                    <p>In a post-apocalyptic world, mutants with incredible powers threaten humanity. Enter the Needless, a group of super-powered individuals who battle these mutants and the sinister organization behind them. Led by the mysterious Adam Blade, the Needless fight to protect what remains of society. As alliances shift and secrets are revealed, the group faces betrayal and danger at every turn. Will they be able to save the world from destruction?</p>
                </div>
            </div>
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/1289/127754l.webp" alt="My Master Has No Tail">
                </div>
                <div class="details">
                    <a href="my-master-has-no-tail"><h3>My Master Has No Tail</h3></a>
                    <p>Other Genre</p>
                    <p>2022</p>
                    <br>
                    <p>In a world where humans coexist with animal spirits, a young girl named Aika dreams of becoming a great spirit-tamer. However, she is surprised to find that her assigned spirit, Kuro, doesn't have a tail like the others. Determined to prove Kuro's worth and mystery, Aika sets out on a journey full of adventures, challenges, and the discovery of the true meaning of friendship and acceptance.</p>
                </div>
            </div>
