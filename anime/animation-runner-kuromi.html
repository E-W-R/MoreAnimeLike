...
<head>
    ...
    <title>More Anime Like Animation Runner Kuromi</title>
...
<body>
    <header>
        <script>const number = "1797";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Animation Runner Kuromi</h2>
                    <p>Drama</p>
                    <p>2001</p>
                    <br>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                ...
                <div class="details">
                    <a href="alien-9"><h3>Alien 9</h3></a>
                    <p>Psychological</p>
                    <p>2001</p>
                    <br>
