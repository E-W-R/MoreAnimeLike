...
<head>
    ...
    <title>More Anime Like When Supernatural Battles Became Commonplace</title>
...
<body>
    <header>
        <script>const number = "25159";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">When Supernatural Battles Became Commonplace</h2>
                    <p>Comedy</p>
                    <p>2014</p>
                    <br>
