...
<head>
    ...
    <title>More Anime Like Elfen Lied</title>
...
<body>
    <header>
        <script>const number = "226";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/1780/121555l.webp" alt="Elfen Lied">
                <div>
                    <h2 id="title">Elfen Lied</h2>
                    <p>Psychological</p>
                    <p>2004</p>
                    <br>
                    <p>In Elfen Lied, the story follows Lucy, a Diclonius - a genetically modified human with telekinetic powers. After escaping from a research facility, Lucy suffers amnesia and is found by two cousins, Kouta and Yuka, who take her in. As Lucy's hidden dark past and the brutal experiments she endured are slowly revealed, the trio becomes entangled in a cycle of violence and betrayal involving other Diclonius and the organization hunting them down.</p>
                </div>
            </div>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                ...
                <div class="details">
                    <a href="psychic-princess"><h3>Psychic Princess</h3></a>
                    <p>Romance</p>
                    <p>2018</p>
                    <br>
