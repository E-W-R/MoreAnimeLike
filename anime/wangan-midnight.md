...
<head>
    ...
    <title>More Anime Like Wangan Midnight</title>
...
<body>
    <header>
        <script>const number = "2608";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/11/12936l.webp" alt="Wangan Midnight">
                <div>
                    <h2 id="title">Wangan Midnight</h2>
                    <p>Action</p>
                    <p>2007</p>
                    <br>
                    <p>Wangan Midnight follows Akio Asakura, a street racer who becomes entangled in the underground racing scene on the Wangan highway. With his high-speed machine, the devil Z, Akio faces off against rival racers, including the mysterious Blackbird and the ambitious Reina Akikawa. As Akio pushes the limits of his car and his skills, he must navigate dangerous competitions and personal challenges to prove himself as the fastest racer on the Wangan.</p>
                </div>
            </div>
