...
<head>
    ...
    <title>More Anime Like High School DxD BorN</title>
...
<body>
    <header>
        <script>const number = "24703";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">High School DxD BorN</h2>
                    <p>Action</p>
                    <p>2015</p>
                    <br>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/1427/120586l.jpg" alt="Shenmue the Animation">
                </div>
                <div class="details">
                    <a href="shenmue-the-animation"><h3>Shenmue the Animation</h3></a>
                    <p>Action</p>
                    <p>2022</p>
                    <br>
                    <p>In Shenmue the Animation, the story follows a young martial artist named Ryo Hazuki on his quest for vengeance after witnessing his father's murder. He embarks on a journey to unravel the mystery behind the elusive Chinese cartel responsible for the tragedy. Along the way, Ryo discovers powerful allies and formidable foes as he delves deeper into a dangerous criminal underworld. Will he achieve his goal or be consumed by the darkness?</p>
                </div>
            </div>
