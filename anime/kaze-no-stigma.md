...
<head>
    ...
    <title>More Anime Like Kaze no Stigma</title>
...
<body>
    <header>
        <script>const number = "1691";</script>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/10/19969l.jpg" alt="Witch Hunter Robin">
                </div>
                <div class="details">
                    <a href="witch-hunter-robin"><h3>Witch Hunter Robin</h3></a>
                    <p>Mystery</p>
                    <p>2002</p>
                    <br>
                    <p>In a world where witches exist alongside humans, a secretive organization known as the STN-J is tasked with capturing and neutralizing rogue witches. Young witch hunter Robin Sena joins the team, using her unique powers to track down those who abuse their abilities. As Robin delves deeper into the world of witches, she begins to uncover dark secrets and questions the true motives of the organization she works for.</p>
                </div>
            </div>
