...
<head>
    ...
    <title>More Anime Like Suppose a Kid from the Last Dungeon Boonies Moved to a Starter Town?</title>
...
<body>
    <header>
        <script>const number = "40594";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Suppose a Kid from the Last Dungeon Boonies Moved to a Starter Town?</h2>
                    <p>Other Genre</p>
                    <p>2021</p>
                    <br>
