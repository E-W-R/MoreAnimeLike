...
<head>
    ...
    <title>More Anime Like Heidi: Girl of the Alps</title>
...
<body>
    <header>
        <script>const number = "2225";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Heidi: Girl of the Alps</h2>
                    <p>Drama</p>
                    <p>1974</p>
                    <br>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                ...
                <div class="details">
                    <a href="anne-of-green-gables"><h3>Anne of Green Gables</h3></a>
                    <p>Drama</p>
                    <p>1979</p>
                    <br>
