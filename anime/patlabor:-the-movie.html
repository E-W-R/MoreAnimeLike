...
<head>
    ...
    <title>More Anime Like Patlabor: The Movie</title>
...
<body>
    <header>
        <script>const number = "1095";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Patlabor: The Movie</h2>
                    <p>Action</p>
                    <p>1989</p>
                    <br>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                ...
                <div class="details">
                    <a href="the-sky-crawlers"><h3>The Sky Crawlers</h3></a>
                    <p>Drama</p>
                    <p>2008</p>
                    <br>
