...
<head>
    ...
    <title>More Anime Like Powerpuff Girls Z</title>
...
<body>
    <header>
        <script>const number = "1221";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/12/3253l.jpg" alt="Powerpuff Girls Z">
                <div>
                    <h2 id="title">Powerpuff Girls Z</h2>
                    <p>Action</p>
                    <p>2006</p>
                    <br>
                    <p>In Powerpuff Girls Z, three ordinary girls transform into superheroes using chemical X to protect Tokyo City from evil monsters. Blossom, Bubbles, and Buttercup must balance their lives as teenagers with their responsibility to save the city from Mojo Jojo and his allies. With their unique powers and strong bond of friendship, the Powerpuff Girls Z fight against threats to ensure peace and harmony in their beloved city.</p>
                </div>
            </div>
