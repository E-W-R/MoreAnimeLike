...
<head>
    ...
    <title>More Anime Like Kabukibu!</title>
...
<body>
    <header>
        <script>const number = "33840";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/4/85291l.jpg" alt="Kabukibu!">
                <div>
                    <h2 id="title">Kabukibu!</h2>
                    <p>Other Genre</p>
                    <p>2017</p>
                    <br>
                    <p>Kabukibu! follows Kurogo Kurusu, a high school student passionate about Kabuki theater. Determined to revive the school's defunct Kabuki club, Kurogo takes on the challenge of recruiting new members and putting on a successful performance. Along the way, he faces various obstacles as he works towards his goal of introducing and preserving the traditional art of Kabuki to a new generation.</p>
                </div>
            </div>
