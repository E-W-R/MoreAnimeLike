...
<head>
    ...
    <title>More Anime Like Ane Log: Big Sister Moyako's Never-ending Monologue</title>
...
<body>
    <header>
        <script>const number = "24531";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Ane Log: Big Sister Moyako's Never-ending Monologue</h2>
                    <p>Comedy</p>
                    <p>2014</p>
                    <br>
