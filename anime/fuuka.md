...
<head>
    ...
    <title>More Anime Like Fuuka</title>
...
<body>
    <header>
        <script>const number = "33743";</script>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/4/15900l.webp" alt="Lamune">
                </div>
                <div class="details">
                    <a href="lamune"><h3>Lamune</h3></a>
                    <p>Romance</p>
                    <p>2005</p>
                    <br>
                    <p>In Lamune, a nostalgic tale unfolds as two childhood friends, Kenji and Nanami, reconnect after years apart. The series follows their heartwarming journey as they navigate the challenges of growing up, facing their past, and discovering new feelings for each other. Filled with bittersweet moments and emotional revelations, Lamune explores the power of friendship and love in shaping their lives.</p>
                </div>
            </div>
