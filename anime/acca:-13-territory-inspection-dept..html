...
<head>
    ...
    <title>More Anime Like ACCA: 13-Territory Inspection Dept.</title>
...
<body>
    <header>
        <script>const number = "33337";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">ACCA: 13-Territory Inspection Dept.</h2>
                    <p>Mystery</p>
                    <p>2017</p>
                    <br>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                ...
                <div class="details">
                    <a href="pet-shop-of-horrors"><h3>Pet Shop of Horrors</h3></a>
                    <p>Mystery</p>
                    <p>1999</p>
                    <br>
