...
<head>
    ...
    <title>More Anime Like Kimagure Orange Road</title>
...
<body>
    <header>
        <script>const number = "1087";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/1960/142715l.jpg" alt="Kimagure Orange Road">
                <div>
                    <h2 id="title">Kimagure Orange Road</h2>
                    <p>Romance</p>
                    <p>1987</p>
                    <br>
                    <p>Kimagure Orange Road follows the story of Kyosuke, a high school student with telekinetic powers, and his love triangle involving two girls: the lively and impulsive Madoka and the sweet and gentle Hikaru. As Kyosuke navigates his feelings and supernatural abilities, romantic entanglements and comedic mishaps ensue. With the support of his quirky family, including his younger siblings who also possess powers, Kyosuke faces the challenges of adolescence and young love.</p>
                </div>
            </div>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/7/53549l.webp" alt="A Lull in the Sea">
                </div>
                <div class="details">
                    <a href="a-lull-in-the-sea"><h3>A Lull in the Sea</h3></a>
                    <p>Romance</p>
                    <p>2013</p>
                    <br>
                    <p>In a world where underwater and above-water civilizations coexist, four sea-dwelling teenagers attend school on the surface. As they navigate the challenges of cultural differences and personal relationships, long-buried secrets come to light, threatening the fragile peace between the two worlds. Torn between their feelings and their duty, the teenagers must confront their own beliefs and prejudices to find a way to bridge the growing divide.</p>
                </div>
            </div>
