...
<head>
    ...
    <title>More Anime Like Hiiro no Kakera: The Tamayori Princess Saga</title>
...
<body>
    <header>
        <script>const number = "12461";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Hiiro no Kakera: The Tamayori Princess Saga</h2>
                    <p>Romance</p>
                    <p>2012</p>
                    <br>
