...
<head>
    ...
    <title>More Anime Like Tokyo Majin</title>
...
<body>
    <header>
        <script>const number = "1860";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/1894/113730l.jpg" alt="Tokyo Majin">
                <div>
                    <h2 id="title">Tokyo Majin</h2>
                    <p>Action</p>
                    <p>2007</p>
                    <br>
                    <p>In Tokyo Majin, a group of high school students discover they are all linked by supernatural powers. As they navigate through mysterious and dangerous occurrences in Tokyo, they must learn to control their abilities to fight against demonic forces threatening the city. Together, they form a powerful team to uncover the truth behind the supernatural occurrences while facing formidable enemies and uncovering dark secrets along the way.</p>
                </div>
            </div>
