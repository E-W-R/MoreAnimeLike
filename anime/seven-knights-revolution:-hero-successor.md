...
<head>
    ...
    <title>More Anime Like Seven Knights Revolution: Hero Successor</title>
...
<body>
    <header>
        <script>const number = "47391";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Seven Knights Revolution: Hero Successor</h2>
                    <p>Action</p>
                    <p>2021</p>
                    <br>
