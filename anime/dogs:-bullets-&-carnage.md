...
<head>
    ...
    <title>More Anime Like Dogs: Bullets & Carnage</title>
...
<body>
    <header>
        <script>const number = "5593";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Dogs: Bullets & Carnage</h2>
                    <p>Action</p>
                    <p>2009</p>
                    <br>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/10/75210l.webp" alt="Bus Gamer">
                </div>
                <div class="details">
                    <a href="bus-gamer"><h3>Bus Gamer</h3></a>
                    <p>Mystery</p>
                    <p>2008</p>
                    <br>
                    <p>Bus Gamer follows three individuals who participate in a deadly underground game where contestants must travel through the city on a bus while completing various tasks to earn points. The winner receives a large sum of money. As the game progresses, the competitors face intense challenges and betrayal, testing their skills and teamwork. With high stakes and unexpected twists, the trio must use their wits and determination to outsmart their opponents and emerge victorious.</p>
                </div>
            </div>
