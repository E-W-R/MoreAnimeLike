...
<head>
    ...
    <title>More Anime Like Ao-chan Can't Study!</title>
...
<body>
    <header>
        <script>const number = "38778";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Ao-chan Can't Study!</h2>
                    <p>Romance</p>
                    <p>2019</p>
                    <br>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/1555/100447l.webp" alt="RobiHachi">
                </div>
                <div class="details">
                    <a href="robihachi"><h3>RobiHachi</h3></a>
                    <p>Comedy</p>
                    <p>2019</p>
                    <br>
                    <p>In RobiHachi, an unemployed man named Robby crosses paths with a young man named Hatchi who dreams of traveling to a legendary planet. Together, they embark on a comedic and adventurous journey through space, facing various challenges and meeting quirky characters along the way. With space pirates, galactic police, and unexpected twists, their daring escapades become a wild ride full of laughter and excitement. &#8203</p>
                </div>
            </div>
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/11/51995l.webp" alt="Theatre of Darkness: Yamishibai">
                </div>
                <div class="details">
                    <a href="theatre-of-darkness%3A-yamishibai"><h3>Theatre of Darkness: Yamishibai</h3></a>
                    <p>Other Genre</p>
                    <p>2013</p>
                    <br>
                    <p>In Theatre of Darkness: Yamishibai, a mysterious storyteller known as the Master of Shadows appears in a park to share chilling urban legends with unsuspecting children. As each eerie tale unfolds through traditional paper-cut animation, the characters find themselves confronting supernatural entities and facing terrifying consequences. The stories delve into the darkest corners of Japanese folklore, leaving viewers on the edge of their seats with each spine-tingling revelation.</p>
                </div>
            </div>
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/1934/111399l.jpg" alt="Kochoki">
                </div>
                <div class="details">
                    <a href="kochoki"><h3>Kochoki</h3></a>
                    <p>Action</p>
                    <p>2019</p>
                    <br>
                    <p>Kochoki follows the story of Oda Nobunaga, a legendary warlord in feudal Japan, and his loyal retainer, Toyotomi Hideyoshi. As they navigate the tumultuous Sengoku period, they face political intrigue, betrayal, and fierce battles in their quest for power and unification of the war-torn country. With ambitions and rival warlords standing in their way, Nobunaga and Hideyoshi must outwit their enemies to achieve their goals and secure their place in history.</p>
                </div>
            </div>
