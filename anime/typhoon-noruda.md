...
<head>
    ...
    <title>More Anime Like Typhoon Noruda</title>
...
<body>
    <header>
        <script>const number = "30585";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/8/73450l.jpg" alt="Typhoon Noruda">
                <div>
                    <h2 id="title">Typhoon Noruda</h2>
                    <p>Drama</p>
                    <p>2015</p>
                    <br>
                    <p>When a powerful typhoon approaches, two high school students, Azuma and Saijo, find themselves caught in a mysterious phenomenon that grants them strange new abilities. As the storm rages on, the boys must navigate their budding powers and unraveled emotions to confront the truth behind the enigmatic girl known as Noruda and the supernatural events unfolding around them. The story unfolds as they try to make sense of the extraordinary events happening amidst the chaos of the typhoon.</p>
                </div>
            </div>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                ...
                <div class="details">
                    <a href="voices-of-a-distant-star"><h3>Voices of a Distant Star</h3></a>
                    <p>Romance</p>
                    <p>2002</p>
                    <br>
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/10/86521l.jpg" alt="Fireworks">
                </div>
                <div class="details">
                    <a href="fireworks"><h3>Fireworks</h3></a>
                    <p>Romance</p>
                    <p>2017</p>
                    <br>
                    <p>During the annual summer festival, a group of friends stumbles upon a peculiar device that can turn back time. As they explore the possibilities of changing the past, they soon realize the consequences of their actions and must make difficult decisions that will impact not only their lives but also those around them. Amidst the dazzling fireworks and fleeting moments, they navigate through love, friendship, and the bittersweet nature of growing up.</p>
                </div>
            </div>
