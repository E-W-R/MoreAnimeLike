...
<head>
    ...
    <title>More Anime Like Star Blazers: Space Battleship Yamato 2199</title>
...
<body>
    <header>
        <script>const number = "12029";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Star Blazers: Space Battleship Yamato 2199</h2>
                    <p>Action</p>
                    <p>2012</p>
                    <br>
