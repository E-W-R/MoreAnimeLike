...
<head>
    ...
    <title>More Anime Like Kite Liberator</title>
...
<body>
    <header>
        <script>const number = "3323";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/11/10228l.jpg" alt="Kite Liberator">
                <div>
                    <h2 id="title">Kite Liberator</h2>
                    <p>Action</p>
                    <p>2008</p>
                    <br>
                    <p>In Kite Liberator, a young assassin named Monaka navigates the dangerous world of contract killing. A chance encounter with a mysterious girl sets off a chain of events that forces Monaka to question her own existence and the secrets surrounding her past. As she seeks answers, Monaka must confront powerful enemies and uncover the truth behind the deadly conspiracy that threatens her life and the lives of those around her.</p>
                </div>
            </div>
