...
<head>
    ...
    <title>More Anime Like The Wallflower</title>
...
<body>
    <header>
        <script>const number = "1562";</script>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/2/85592l.jpg" alt="Tsukigakirei">
                </div>
                <div class="details">
                    <a href="tsukigakirei"><h3>Tsukigakirei</h3></a>
                    <p>Romance</p>
                    <p>2017</p>
                    <br>
                    <p>Tsukigakirei follows the evolving relationship between two middle school students, Akane Mizuno and Kotarou Azumi. As they navigate through the challenges of adolescence, such as exams, extracurricular activities, and friendships, they find themselves drawn to each other. Despite their different personalities and interests, they slowly develop a deep connection that transcends their initial awkward interactions. The series highlights the sweet, innocent moments of first love and the struggles of growing up.</p>
                </div>
            </div>
