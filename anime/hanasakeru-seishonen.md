...
<head>
    ...
    <title>More Anime Like Hanasakeru Seishonen</title>
...
<body>
    <header>
        <script>const number = "5835";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Hanasakeru Seishonen</h2>
                    <p>Romance</p>
                    <p>2009</p>
                    <br>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                ...
                <div class="details">
                    <a href="scum%27s-wish"><h3>Scum's Wish</h3></a>
                    <p>Romance</p>
                    <p>2017</p>
                    <br>
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/13/33465l.webp" alt="The Future Diary">
                </div>
                <div class="details">
                    <a href="the-future-diary"><h3>The Future Diary</h3></a>
                    <p>Psychological</p>
                    <p>2011</p>
                    <br>
                    <p>The Future Diary follows a high school student who gains a diary that can predict the future. He becomes embroiled in a deadly game with other diary holders, each possessing their own unique future-seeing diary. As the competition escalates, alliances are formed, trust is tested, and the boundary between friend and foe blurs. With the fate of the world at stake, the protagonist must navigate the dangerous game of survival and outwit his opponents to emerge victorious.</p>
                </div>
            </div>
