...
<head>
    ...
    <title>More Anime Like Bobobo-bo Bo-bobo</title>
...
<body>
    <header>
        <script>const number = "1050";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/1293/136965l.jpg" alt="Bobobo-bo Bo-bobo">
                <div>
                    <h2 id="title">Bobobo-bo Bo-bobo</h2>
                    <p>Comedy</p>
                    <p>2003</p>
                    <br>
                    <p>In a world where hair is controlled by an evil empire, Bobobo-bo Bo-bobo, a quirky and powerful warrior with the ability to manipulate his own hair as a weapon, rises up to stop them. Alongside his ragtag group of rebels, including the timid Beauty and the talking donut Heppokomaru, they embark on a wild and absurd journey to defeat the empire and save the day with their bizarre hair-based powers and comedic antics.</p>
                </div>
            </div>
