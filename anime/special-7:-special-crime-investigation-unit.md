...
<head>
    ...
    <title>More Anime Like Special 7: Special Crime Investigation Unit</title>
...
<body>
    <header>
        <script>const number = "39567";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Special 7: Special Crime Investigation Unit</h2>
                    <p>Mystery</p>
                    <p>2019</p>
                    <br>
