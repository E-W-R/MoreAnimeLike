...
<head>
    ...
    <title>More Anime Like Horizon in the Middle of Nowhere</title>
...
<body>
    <header>
        <script>const number = "10456";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/6/79598l.jpg" alt="Horizon in the Middle of Nowhere">
                <div>
                    <h2 id="title">Horizon in the Middle of Nowhere</h2>
                    <p>Action</p>
                    <p>2011</p>
                    <br>
                    <p>In a distant future where Earth has been devastated, nations coexist on giant floating cities. To prevent another catastrophe, students from different countries attend a school aboard a massive ship. Among them is a young man seeking to fulfill a promise to his childhood friend. As political tensions rise and mysterious forces threaten peace, he must navigate a complex web of alliances and conflicts to protect his loved ones and discover the truth about the past.</p>
                </div>
            </div>
