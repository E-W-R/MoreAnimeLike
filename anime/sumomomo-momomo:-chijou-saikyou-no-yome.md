...
<head>
    ...
    <title>More Anime Like Sumomomo Momomo: Chijou Saikyou no Yome</title>
...
<body>
    <header>
        <script>const number = "1568";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Sumomomo Momomo: Chijou Saikyou no Yome</h2>
                    <p>Romance</p>
                    <p>2006</p>
                    <br>
