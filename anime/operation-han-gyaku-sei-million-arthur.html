...
<head>
    ...
    <title>More Anime Like Operation Han-Gyaku-Sei Million Arthur</title>
...
<body>
    <header>
        <script>const number = "37555";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Operation Han-Gyaku-Sei Million Arthur</h2>
                    <p>Action</p>
                    <p>2018</p>
                    <br>
