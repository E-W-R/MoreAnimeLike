...
<head>
    ...
    <title>More Anime Like Kuttsukiboshi</title>
...
<body>
    <header>
        <script>const number = "9014";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/7/25761l.jpg" alt="Kuttsukiboshi">
                <div>
                    <h2 id="title">Kuttsukiboshi</h2>
                    <p>Drama</p>
                    <p>2010</p>
                    <br>
                    <p>Kuttsukiboshi follows the lives of two high school girls, Kiiko and Aaya, who share a close bond. However, their friendship takes a complicated turn when Kiiko discovers she possesses supernatural abilities. As their relationship deepens, they must navigate the challenges of love and the consequences of Kiiko's powers. The series explores the complexities of their emotional connection and the limits they are willing to push for the sake of their love.</p>
                </div>
            </div>
