...
<head>
    ...
    <title>More Anime Like Science Fell in Love, So I Tried to Prove It</title>
...
<body>
    <header>
        <script>const number = "38992";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Science Fell in Love, So I Tried to Prove It</h2>
                    <p>Romance</p>
                    <p>2020</p>
                    <br>
