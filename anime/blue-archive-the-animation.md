...
<head>
    ...
    <title>More Anime Like Blue Archive the Animation</title>
...
<body>
    <header>
        <script>const number = "54309";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/1739/140995l.jpg" alt="Blue Archive the Animation">
                <div>
                    <h2 id="title">Blue Archive the Animation</h2>
                    <p>Action</p>
                    <p>2024</p>
                    <br>
                    <p>In a world where mysterious creatures known as Phantoms threaten society, an elite group of high school students must train at the prestigious academy, Blue Archive, to hone their abilities and protect humanity. As they grow stronger and form bonds with each other, they uncover dark secrets surrounding the origins of the Phantoms and the true purpose of their training. With their friendships tested and the fate of the world at stake, the students must band together to face the impending danger.</p>
                </div>
            </div>
