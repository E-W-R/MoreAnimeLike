...
<head>
    ...
    <title>More Anime Like Sekko Boys</title>
...
<body>
    <header>
        <script>const number = "31540";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/5/77840l.jpg" alt="Sekko Boys">
                <div>
                    <h2 id="title">Sekko Boys</h2>
                    <p>Comedy</p>
                    <p>2016</p>
                    <br>
                    <p>Four handsome busts of Greek sculptures are brought to life as the idol group Sekko Boys. Their rookie manager, Miki, must navigate the ups and downs of the entertainment industry while dealing with her unusual clients. With their egos, quirks, and unique personalities, Sekko Boys find themselves in comical situations as they strive for stardom. Can these marble idols become the next big thing in the world of entertainment?</p>
                </div>
            </div>
