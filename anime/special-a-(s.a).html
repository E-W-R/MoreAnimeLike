...
<head>
    ...
    <title>More Anime Like Special A (S.A)</title>
...
<body>
    <header>
        <script>const number = "3470";</script>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/10/24649l.webp" alt="Trinity Blood">
                </div>
                <div class="details">
                    <a href="trinity-blood"><h3>Trinity Blood</h3></a>
                    <p>Action</p>
                    <p>2005</p>
                    <br>
                    <p>In a post-apocalyptic world where humans and vampires are at war, a powerful vampire known as Abel Nightroad works as a priest to seek peace between the two races. With his incredible combat skills and mysterious past, Abel becomes entangled in a web of political intrigue, betrayal, and ancient conspiracies as he fights to prevent a catastrophic war that could destroy what remains of humanity.</p>
                </div>
            </div>
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/1287/114435l.jpg" alt="Library Wars">
                </div>
                <div class="details">
                    <a href="library-wars"><h3>Library Wars</h3></a>
                    <p>Romance</p>
                    <p>2008</p>
                    <br>
                    <p>In a society where the government restricts freedom of expression by censoring books, the Library Defense Force is formed to protect intellectual freedom and preserve knowledge. Young recruit Iku Kasahara joins the force, determined to uphold the principle that books should never be destroyed. As she undergoes rigorous training and missions to defend libraries, Iku must navigate the challenges of standing up for what she believes in while facing dangerous foes who seek to suppress information.</p>
                </div>
            </div>
