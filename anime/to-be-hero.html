...
<head>
    ...
    <title>More Anime Like To Be Hero</title>
...
<body>
    <header>
        <script>const number = "34009";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/2/82347l.jpg" alt="To Be Hero">
                <div>
                    <h2 id="title">To Be Hero</h2>
                    <p>Comedy</p>
                    <p>2016</p>
                    <br>
                    <p>To Be Hero follows the story of a selfish and crude man named Ossan who is suddenly transformed into a hero with a magical toilet seat. Struggling to balance his newfound responsibilities with his personal life, Ossan must protect Earth from mysterious invaders while also navigating the challenges of fatherhood. As he battles bizarre foes and uncovers dark secrets, Ossan's journey as a reluctant hero forces him to confront his own flaws and grow as a person.</p>
                </div>
            </div>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                ...
                <div class="details">
                    <a href="a-sister%27s-all-you-need"><h3>A Sister's All You Need</h3></a>
                    <p>Romance</p>
                    <p>2017</p>
                    <br>
