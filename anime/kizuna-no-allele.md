...
<head>
    ...
    <title>More Anime Like Kizuna no Allele</title>
...
<body>
    <header>
        <script>const number = "51139";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/1632/133752l.jpg" alt="Kizuna no Allele">
                <div>
                    <h2 id="title">Kizuna no Allele</h2>
                    <p>Other Genre</p>
                    <p>2023</p>
                    <br>
                    <p>In a world where people possess genetically inherited abilities known as Alleles, a young man named Hiro learns about a sinister plot involving the manipulation of Alleles. Determined to uncover the truth behind his family's mysterious past, Hiro sets out on a journey to confront powerful forces that seek to control these supernatural abilities. Along the way, he forms unexpected alliances and faces dangerous adversaries, all while unraveling the secrets of his own identity.</p>
                </div>
            </div>
