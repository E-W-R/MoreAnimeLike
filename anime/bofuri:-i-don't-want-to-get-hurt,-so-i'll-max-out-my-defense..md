...
<head>
    ...
    <title>More Anime Like BOFURI: I Don't Want to Get Hurt, so I'll Max Out My Defense.</title>
...
<body>
    <header>
        <script>const number = "38790";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">BOFURI: I Don't Want to Get Hurt, so I'll Max Out My Defense.</h2>
                    <p>Action</p>
                    <p>2020</p>
                    <br>
