...
<head>
    ...
    <title>More Anime Like Last Period: The Journey to the End of the Despair</title>
...
<body>
    <header>
        <script>const number = "37254";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Last Period: The Journey to the End of the Despair</h2>
                    <p>Action</p>
                    <p>2018</p>
                    <br>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                ...
                <div class="details">
                    <a href="black-rock-shooter"><h3>Black Rock Shooter</h3></a>
                    <p>Action</p>
                    <p>2012</p>
                    <br>
