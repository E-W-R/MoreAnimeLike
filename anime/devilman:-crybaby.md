...
<head>
    ...
    <title>More Anime Like Devilman: Crybaby</title>
...
<body>
    <header>
        <script>const number = "35120";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/2/89973l.webp" alt="Devilman: Crybaby">
                <div>
                    <h2 id="title">Devilman: Crybaby</h2>
                    <p>Action</p>
                    <p>2018</p>
                    <br>
                    <p>When Akira fuses with the demon Amon, he becomes Devilman—possessing the demon's powers but retaining his human heart. As demonic beings rise to conquer Earth, Akira must navigate between his two identities to protect his loved ones and humanity from the impending apocalypse. With the help of his friend, Ryo, Akira dives deeper into the dark reality of demons and the complexities of human nature. The battle for survival becomes a personal and moral struggle for Akira as he fights against both his own kind and his inner demons.</p>
                </div>
            </div>
