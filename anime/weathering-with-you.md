...
<head>
    ...
    <title>More Anime Like Weathering with You</title>
...
<body>
    <header>
        <script>const number = "38826";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Weathering with You</h2>
                    <p>Romance</p>
                    <p>2019</p>
                    <br>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/10/77957l.jpg" alt="Erased">
                </div>
                <div class="details">
                    <a href="erased"><h3>Erased</h3></a>
                    <p>Mystery</p>
                    <p>2016</p>
                    <br>
                    <p>Satoru possesses an ability to travel back in time moments before a tragedy strikes, allowing him to prevent disasters. When he is wrongly accused of murder, Satoru finds himself transported back 18 years to his childhood. He must uncover the truth behind a series of kidnappings in order to prevent the tragic events that shaped his life and those around him. With the clock ticking, Satoru races against time to alter the past and save the ones he loves.</p>
                </div>
            </div>
