...
<head>
    ...
    <title>More Anime Like Cross Game</title>
...
<body>
    <header>
        <script>const number = "5941";</script>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/6/17576l.jpg" alt="Maison Ikkoku">
                </div>
                <div class="details">
                    <a href="maison-ikkoku"><h3>Maison Ikkoku</h3></a>
                    <p>Romance</p>
                    <p>1986</p>
                    <br>
                    <p>Maison Ikkoku follows the story of Yusaku Godai, a hapless student, who falls in love with his beautiful and widowed apartment manager, Kyoko Otonashi. As Godai navigates his feelings for Kyoko, he must also contend with eccentric neighbors and his own insecurities. The series beautifully explores the ups and downs of love and the challenges of growing up, all set against the backdrop of the quirky residents of Maison Ikkoku.</p>
                </div>
            </div>
