...
<head>
    ...
    <title>More Anime Like The Girl From the Other Side: Siúil, a Rún</title>
...
<body>
    <header>
        <script>const number = "39495";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">The Girl From the Other Side: Siúil, a Rún</h2>
                    <p>Other Genre</p>
                    <p>2019</p>
                    <br>
