...
<head>
    ...
    <title>More Anime Like Oruchuban Ebichu</title>
...
<body>
    <header>
        <script>const number = "1060";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/4/79591l.jpg" alt="Oruchuban Ebichu">
                <div>
                    <h2 id="title">Oruchuban Ebichu</h2>
                    <p>Comedy</p>
                    <p>1999</p>
                    <br>
                    <p>Oruchuban Ebichu follows the misadventures of a talking hamster named Ebichu who tries her best to keep her owner's household in order, despite her clumsy nature. From dealing with relationship problems to tackling household chores, Ebichu finds herself in various comedic situations as she navigates through the daily lives of her owner and his girlfriend. Will Ebichu's well-intentioned actions lead to chaos or bring happiness to those around her?</p>
                </div>
            </div>
