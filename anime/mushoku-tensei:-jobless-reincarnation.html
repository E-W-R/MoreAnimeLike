...
<head>
    ...
    <title>More Anime Like Mushoku Tensei: Jobless Reincarnation</title>
...
<body>
    <header>
        <script>const number = "39535";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Mushoku Tensei: Jobless Reincarnation</h2>
                    <p>Isekai</p>
                    <p>2021</p>
                    <br>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/1522/128039l.webp" alt="Re:ZERO -Starting Life in Another World-">
                </div>
                <div class="details">
                    <a href="re%3Azero--starting-life-in-another-world-"><h3>Re:ZERO -Starting Life in Another World-</h3></a>
                    <p>Isekai</p>
                    <p>2016</p>
                    <br>
                    <p>After being transported to a fantasy world, Subaru Natsuki discovers he has the ability to rewind time whenever he dies. Determined to save his new friends and unravel the mysteries of this world, Subaru must navigate a series of dangerous and emotional challenges. With the help of a silver-haired half-elf named Emilia and a colorful cast of characters, Subaru faces both powerful allies and formidable enemies in his quest for answers.</p>
                </div>
            </div>
