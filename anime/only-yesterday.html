...
<head>
    ...
    <title>More Anime Like Only Yesterday</title>
...
<body>
    <header>
        <script>const number = "1029";</script>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/8/18922l.jpg" alt="NieA Under 7">
                </div>
                <div class="details">
                    <a href="niea-under-7"><h3>NieA Under 7</h3></a>
                    <p>Other Genre</p>
                    <p>2000</p>
                    <br>
                    <p>In the near future, Earth is visited by aliens, including NieA, a carefree extraterrestrial living in the basement of a struggling college student named Mayuko. Despite their differences, the two form an unlikely friendship as they navigate everyday life, including their respective struggles and dreams. Together, they discover the importance of acceptance, understanding, and the beauty of friendship in a world filled with uncertainties.</p>
                </div>
            </div>
