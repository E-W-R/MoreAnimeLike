...
<head>
    ...
    <title>More Anime Like We Without Wings – Under the Innocent Sky</title>
...
<body>
    <header>
        <script>const number = "9922";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">We Without Wings – Under the Innocent Sky</h2>
                    <p>Romance</p>
                    <p>2011</p>
                    <br>
