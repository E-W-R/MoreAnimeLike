...
<head>
    ...
    <title>More Anime Like Pet Shop of Horrors</title>
...
<body>
    <header>
        <script>const number = "326";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/10/64543l.jpg" alt="Pet Shop of Horrors">
                <div>
                    <h2 id="title">Pet Shop of Horrors</h2>
                    <p>Mystery</p>
                    <p>1999</p>
                    <br>
                    <p>In the Pet Shop of Horrors, Count D owns a mysterious pet shop in Chinatown that sells fantastical and exotic creatures to customers. Each pet comes with strict rules, and any deviation leads to terrifying consequences. As customers navigate through their relationships with these pets, they uncover dark secrets and face moral dilemmas. The series delves into the eerie and chilling encounters between the shop's peculiar animals and their owners.</p>
                </div>
            </div>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/1301/110433l.webp" alt="Talentless Nana">
                </div>
                <div class="details">
                    <a href="talentless-nana"><h3>Talentless Nana</h3></a>
                    <p>Psychological</p>
                    <p>2020</p>
                    <br>
                    <p>In a world where teenagers possess superhuman abilities, an elite group of students with special powers are sent to a secluded island to train. Nanao Nakajima joins the group, but soon discovers a sinister secret - some students are being mysteriously killed. As the deaths continue, suspicion falls on Nanao as he tries to uncover the truth behind the killings. Filled with suspense and twists, Talentless Nana unravels a thrilling mystery of betrayal and deception.</p>
                </div>
            </div>
