...
<head>
    ...
    <title>More Anime Like Miss Shachiku and the Little Baby Ghost</title>
...
<body>
    <header>
        <script>const number = "49160";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Miss Shachiku and the Little Baby Ghost</h2>
                    <p>Comedy</p>
                    <p>2022</p>
                    <br>
