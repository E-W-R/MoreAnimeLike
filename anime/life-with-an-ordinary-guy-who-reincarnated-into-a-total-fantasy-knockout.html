...
<head>
    ...
    <title>More Anime Like Life with an Ordinary Guy who Reincarnated into a Total Fantasy Knockout</title>
...
<body>
    <header>
        <script>const number = "48997";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Life with an Ordinary Guy who Reincarnated into a Total Fantasy Knockout</h2>
                    <p>Isekai</p>
                    <p>2022</p>
                    <br>
