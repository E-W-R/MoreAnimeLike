...
<head>
    ...
    <title>More Anime Like How a Realist Hero Rebuilt the Kingdom</title>
...
<body>
    <header>
        <script>const number = "41710";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">How a Realist Hero Rebuilt the Kingdom</h2>
                    <p>Isekai</p>
                    <p>2021</p>
                    <br>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/1355/111545l.jpg" alt="Kiyo in Kyoto: From the Maiko House">
                </div>
                <div class="details">
                    <a href="kiyo-in-kyoto%3A-from-the-maiko-house"><h3>Kiyo in Kyoto: From the Maiko House</h3></a>
                    <p>Other Genre</p>
                    <p>2021</p>
                    <br>
                    <p>After losing her parents, Kiyo moves to Kyoto to find her maiko grandmother. She starts working at an okiya to search for clues about her grandmother's whereabouts. While adapting to the traditions and challenges of the maiko lifestyle, Kiyo uncovers family secrets and strengthens bonds with her new friends. Through hard work and determination, she navigates the intricate world of geiko and maiko in the beautiful city of Kyoto.</p>
                </div>
            </div>
