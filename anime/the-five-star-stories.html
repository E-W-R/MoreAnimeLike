...
<head>
    ...
    <title>More Anime Like The Five Star Stories</title>
...
<body>
    <header>
        <script>const number = "2042";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/11/76054l.jpg" alt="The Five Star Stories">
                <div>
                    <h2 id="title">The Five Star Stories</h2>
                    <p>Action</p>
                    <p>1989</p>
                    <br>
                    <p>In a distant galaxy, powerful mech warriors known as Mortar Headds battle for dominance in a feudal system ruled by five royal houses. Amidst political intrigue and betrayals, a young heir to the powerful Mirage Knight bloodline rises to fulfill his destiny and bring about a new era. As the fate of the galaxy hangs in the balance, alliances are formed and enemies clash in epic battles that will determine the future of the Five Star Stories.</p>
                </div>
            </div>
