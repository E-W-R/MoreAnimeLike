...
<head>
    ...
    <title>More Anime Like Death March to the Parallel World Rhapsody</title>
...
<body>
    <header>
        <script>const number = "34497";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                ...
                <div>
                    <h2 id="title">Death March to the Parallel World Rhapsody</h2>
                    <p>Isekai</p>
                    <p>2018</p>
                    <br>
        ...
        <section id="recommendations">
            ...
            <div class="recommendation">
                <div class="graphics">
                    ...
                    <img src="https://cdn.myanimelist.net/images/anime/13/26227l.webp" alt="Iron Man">
                </div>
                <div class="details">
                    <a href="iron-man"><h3>Iron Man</h3></a>
                    <p>Action</p>
                    <p>2010</p>
                    <br>
                    <p>After wealthy inventor Tony Stark is captured by terrorists, he creates a high-tech suit of armor to escape. Realizing the potential to protect the world, he refines the suit and becomes the armored superhero Iron Man. Fighting against threats to humanity and his own weapons falling into the wrong hands, Tony navigates the complexities of being a hero and a man haunted by his past.</p>
                </div>
            </div>
