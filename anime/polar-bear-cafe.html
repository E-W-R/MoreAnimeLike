...
<head>
    ...
    <title>More Anime Like Polar Bear Cafe</title>
...
<body>
    <header>
        <script>const number = "12815";</script>
    ...
    <main>
        <section id="main-anime">
            <div class="anime-details">
                <img src="https://cdn.myanimelist.net/images/anime/6/75649l.jpg" alt="Polar Bear Cafe">
                <div>
                    <h2 id="title">Polar Bear Cafe</h2>
                    <p>Other Genre</p>
                    <p>2012</p>
                    <br>
                    <p>In Polar Bear Cafe, a polar bear runs a cafe in a shopping district where he interacts with his friends, including a panda and a penguin. The slice-of-life anime follows the everyday lives of the animals as they navigate the challenges and joys of running a cafe, making new friends, and experiencing various adventures together. With its heartwarming and funny moments, Polar Bear Cafe offers a light-hearted and entertaining look into the lives of these adorable animal characters.</p>
                </div>
            </div>
